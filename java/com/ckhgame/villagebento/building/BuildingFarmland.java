...
public class BuildingFarmland extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-1,0,-7,Blocks.fence,0);bb.buildBlock(-1,0,-4,Blocks.lit_pumpkin,1);bb.buildBlock(-1,0,-3,Blocks.lit_pumpkin,1);
		bb.buildBlock(-1,0,2,Blocks.wheat,7);bb.buildBlock(-1,0,3,Blocks.wheat,7);bb.buildBlock(-1,0,4,Blocks.wheat,7);
		bb.buildBlock(-1,0,5,Blocks.wheat,7);bb.buildBlock(-1,0,7,Blocks.fence,0);bb.buildBlock(0,0,-7,Blocks.planks,2);
		bb.buildBlock(0,0,-6,Blocks.planks,2);bb.buildBlock(0,0,-5,Blocks.planks,2);bb.buildBlock(0,0,-4,Blocks.planks,2);
		bb.buildBlock(0,0,-3,Blocks.planks,2);bb.buildBlock(0,0,-2,Blocks.planks,2);bb.buildBlock(0,0,-1,Blocks.planks,2);
		...
		bb.buildBlock(1,0,-2,Blocks.hay_block,0);bb.buildBlock(1,0,-1,Blocks.planks,2);bb.buildBlock(1,0,2,Blocks.wheat,7);
		bb.buildBlock(1,0,3,Blocks.wheat,7);bb.buildBlock(1,0,4,Blocks.wheat,7);bb.buildBlock(1,0,5,Blocks.wheat,7);
		bb.buildBlock(1,0,7,Blocks.fence,0);bb.buildBlock(2,0,-7,Blocks.planks,2);bb.buildBlock(2,0,-4,Blocks.bed,0);
		bb.buildBlock(2,0,-3,Blocks.bed,8);bb.buildBlock(2,0,-2,Blocks.hay_block,8);bb.buildBlock(2,0,-1,Blocks.planks,2);
		bb.buildBlock(2,0,7,Blocks.fence,0);bb.buildBlock(3,0,-7,Blocks.planks,2);bb.buildBlock(3,0,-1,Blocks.planks,2);
		bb.buildBlock(3,0,2,Blocks.wheat,7);bb.buildBlock(3,0,3,Blocks.wheat,7);bb.buildBlock(3,0,4,Blocks.wheat,7);
		bb.buildBlock(3,0,5,Blocks.wheat,7);bb.buildBlock(3,0,7,Blocks.fence,0);bb.buildBlock(4,0,-7,Blocks.planks,2);
		bb.buildBlock(4,0,7,Blocks.fence,0);bb.buildBlock(5,0,-7,Blocks.planks,2);bb.buildBlock(5,0,-6,Blocks.planks,2);
		bb.buildBlock(5,0,-1,Blocks.planks,2);bb.buildBlock(5,0,2,Blocks.wheat,7);bb.buildBlock(5,0,3,Blocks.wheat,7);
		bb.buildBlock(5,0,4,Blocks.wheat,7);bb.buildBlock(5,0,5,Blocks.wheat,7);bb.buildBlock(5,0,7,Blocks.fence,0);
		bb.buildBlock(6,0,-7,Blocks.planks,2);bb.buildBlock(6,0,-6,Blocks.planks,2);bb.buildBlock(6,0,-5,Blocks.planks,2);
		bb.buildBlock(6,0,-4,Blocks.wooden_door,4);bb.buildBlock(6,0,-3,Blocks.wooden_door,4);bb.buildBlock(6,0,-2,Blocks.planks,2);
		bb.buildBlock(6,0,-1,Blocks.planks,2);bb.buildBlock(6,0,7,Blocks.fence,0);bb.buildBlock(7,0,-1,Blocks.fence,0);
		bb.buildBlock(7,0,0,Blocks.fence,0);bb.buildBlock(7,0,1,Blocks.fence,0);bb.buildBlock(7,0,2,Blocks.fence,0);
		bb.buildBlock(7,0,3,Blocks.fence,0);bb.buildBlock(7,0,4,Blocks.fence,0);bb.buildBlock(7,0,5,Blocks.fence,0);
		bb.buildBlock(7,0,6,Blocks.fence,0);bb.buildBlock(7,0,7,Blocks.fence,0);bb.buildBlock(-5,1,-5,Blocks.reeds,0);
		bb.buildBlock(-5,1,-4,Blocks.reeds,0);bb.buildBlock(-5,1,-3,Blocks.reeds,0);bb.buildBlock(-5,1,-2,Blocks.reeds,0);
		bb.buildBlock(-3,1,-5,Blocks.reeds,0);bb.buildBlock(-3,1,-4,Blocks.reeds,0);bb.buildBlock(-3,1,-3,Blocks.reeds,0);
		bb.buildBlock(-3,1,-2,Blocks.reeds,0);bb.buildBlock(0,1,-7,Blocks.planks,2);bb.buildBlock(0,1,-6,Blocks.planks,2);
		bb.buildBlock(0,1,-5,Blocks.glass_pane,0);bb.buildBlock(0,1,-4,Blocks.glass_pane,0);bb.buildBlock(0,1,-3,Blocks.glass_pane,0);
		bb.buildBlock(0,1,-2,Blocks.planks,2);bb.buildBlock(0,1,-1,Blocks.planks,2);bb.buildBlock(1,1,-7,Blocks.planks,2);
		bb.buildBlock(1,1,-1,Blocks.planks,2);bb.buildBlock(2,1,-7,Blocks.glass_pane,0);bb.buildBlock(2,1,-1,Blocks.planks,2);
		bb.buildBlock(3,1,-7,Blocks.glass_pane,0);bb.buildBlock(3,1,-1,Blocks.planks,2);bb.buildBlock(4,1,-7,Blocks.glass_pane,0);
		bb.buildBlock(5,1,-7,Blocks.planks,2);bb.buildBlock(5,1,-6,Blocks.flower_pot,0);bb.buildBlock(5,1,-1,Blocks.planks,2);
		...
		bb.buildBlock(6,1,-1,Blocks.planks,2);bb.buildBlock(-5,2,-5,Blocks.reeds,0);bb.buildBlock(-5,2,-4,Blocks.reeds,0);
		bb.buildBlock(-5,2,-3,Blocks.reeds,0);bb.buildBlock(-5,2,-2,Blocks.reeds,0);bb.buildBlock(-3,2,-5,Blocks.reeds,0);
		...
		bb.buildBlock(0,2,-1,Blocks.planks,2);bb.buildBlock(1,2,-7,Blocks.planks,2);bb.buildBlock(1,2,-1,Blocks.planks,2);
		bb.buildBlock(2,2,-7,Blocks.glass_pane,0);bb.buildBlock(2,2,-1,Blocks.planks,2);bb.buildBlock(3,2,-7,Blocks.glass_pane,0);
		bb.buildBlock(3,2,-1,Blocks.planks,2);bb.buildBlock(4,2,-7,Blocks.glass_pane,0);bb.buildBlock(4,2,-1,Blocks.planks,2);
		bb.buildBlock(5,2,-7,Blocks.planks,2);bb.buildBlock(5,2,-1,Blocks.planks,2);bb.buildBlock(6,2,-7,Blocks.planks,2);
