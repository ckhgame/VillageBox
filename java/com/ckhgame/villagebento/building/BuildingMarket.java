...
public class BuildingMarket extends Building {
	...
	protected void generateVillagers(BuildingBuilder bb) {
		...
		//add villager
		bb.addBuildingVillager(VillagerFarmMarketMerchant.class,"Peter",2,0);
		bb.addBuildingVillager(VillagerPastureMarketMerchant.class,"Eric",2,1);
	}
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-2,0,-2,Blocks.flower_pot,0);bb.buildBlock(-2,0,-1,Blocks.flower_pot,0);bb.buildBlock(-2,0,0,Blocks.planks,0);
		bb.buildBlock(-2,0,1,Blocks.flower_pot,0);bb.buildBlock(-2,0,2,Blocks.flower_pot,0);bb.buildBlock(-2,0,3,Blocks.stonebrick,0);
		bb.buildBlock(-2,0,5,Blocks.fence,0);bb.buildBlock(-1,0,-3,Blocks.stonebrick,0);bb.buildBlock(-1,0,-1,Blocks.jungle_stairs,2);
		bb.buildBlock(-1,0,0,Blocks.planks,0);bb.buildBlock(-1,0,1,Blocks.jungle_stairs,3);bb.buildBlock(-1,0,3,Blocks.stonebrick,0);
		bb.buildBlock(0,0,-3,Blocks.stonebrick,0);bb.buildBlock(0,0,0,Blocks.planks,0);bb.buildBlock(0,0,3,Blocks.stonebrick,0);
		bb.buildBlock(1,0,-3,Blocks.stonebrick,0);bb.buildBlock(1,0,0,Blocks.jungle_stairs,1);bb.buildBlock(1,0,3,Blocks.stonebrick,0);
		bb.buildBlock(2,0,-5,Blocks.fence,0);bb.buildBlock(2,0,-3,Blocks.stonebrick,0);bb.buildBlock(2,0,3,Blocks.stonebrick,0);
		bb.buildBlock(2,0,5,Blocks.fence,0);bb.buildBlock(3,0,-3,Blocks.stonebrick,0);bb.buildBlock(3,0,-2,Blocks.stonebrick,0);
		bb.buildBlock(3,0,-1,Blocks.stonebrick,0);bb.buildBlock(3,0,0,Blocks.wooden_door,0);bb.buildBlock(3,0,1,Blocks.stonebrick,0);
		bb.buildBlock(3,0,2,Blocks.stonebrick,0);bb.buildBlock(3,0,3,Blocks.stonebrick,0);bb.buildBlock(4,0,-3,Blocks.jungle_stairs,1);
		bb.buildBlock(4,0,-2,Blocks.jungle_stairs,1);bb.buildBlock(4,0,2,Blocks.jungle_stairs,1);bb.buildBlock(4,0,3,Blocks.jungle_stairs,1);
		bb.buildBlock(-3,1,-3,Blocks.planks,4);bb.buildBlock(-3,1,-2,Blocks.planks,4);bb.buildBlock(-3,1,-1,Blocks.planks,4);
		bb.buildBlock(-3,1,0,Blocks.planks,4);bb.buildBlock(-3,1,1,Blocks.planks,4);bb.buildBlock(-3,1,2,Blocks.planks,4);
		bb.buildBlock(-3,1,3,Blocks.planks,4);bb.buildBlock(-2,1,-5,Blocks.fence,0);bb.buildBlock(-2,1,-3,Blocks.fence,0);
		bb.buildBlock(-2,1,0,Blocks.planks,0);bb.buildBlock(-2,1,3,Blocks.fence,0);bb.buildBlock(-2,1,5,Blocks.fence,0);
		bb.buildBlock(-1,1,-3,Blocks.fence,0);bb.buildBlock(-1,1,0,Blocks.planks,0);bb.buildBlock(-1,1,3,Blocks.fence,0);
		bb.buildBlock(0,1,0,Blocks.jungle_stairs,1);bb.buildBlock(1,1,-3,Blocks.fence,0);bb.buildBlock(1,1,3,Blocks.fence,0);
		bb.buildBlock(2,1,-5,Blocks.fence,0);bb.buildBlock(2,1,-3,Blocks.fence,0);bb.buildBlock(2,1,3,Blocks.fence,0);
		bb.buildBlock(2,1,5,Blocks.fence,0);bb.buildBlock(3,1,-3,Blocks.planks,4);bb.buildBlock(3,1,-2,Blocks.glass_pane,0);
		...
		bb.buildBlock(-3,2,1,Blocks.glass_pane,0);bb.buildBlock(-3,2,2,Blocks.glass_pane,0);bb.buildBlock(-3,2,3,Blocks.planks,4);
		bb.buildBlock(-2,2,-5,Blocks.fence,0);bb.buildBlock(-2,2,-3,Blocks.fence,0);bb.buildBlock(-2,2,0,Blocks.planks,0);
		bb.buildBlock(-2,2,3,Blocks.fence,0);bb.buildBlock(-2,2,5,Blocks.fence,0);bb.buildBlock(-1,2,-3,Blocks.fence,0);
		bb.buildBlock(-1,2,0,Blocks.jungle_stairs,1);bb.buildBlock(-1,2,3,Blocks.fence,0);bb.buildBlock(0,2,-3,Blocks.fence,0);
		bb.buildBlock(0,2,3,Blocks.fence,0);bb.buildBlock(1,2,-3,Blocks.fence,0);bb.buildBlock(1,2,3,Blocks.fence,0);
		bb.buildBlock(2,2,-5,Blocks.fence,0);bb.buildBlock(2,2,-3,Blocks.fence,0);bb.buildBlock(2,2,3,Blocks.fence,0);
		bb.buildBlock(2,2,5,Blocks.fence,0);bb.buildBlock(3,2,-3,Blocks.planks,4);bb.buildBlock(3,2,-2,Blocks.glass_pane,0);
		...
		bb.buildBlock(-2,3,-2,Blocks.wooden_slab,8);bb.buildBlock(-2,3,-1,Blocks.wooden_slab,8);bb.buildBlock(-2,3,0,Blocks.jungle_stairs,1);
		bb.buildBlock(-2,3,1,Blocks.wooden_slab,8);bb.buildBlock(-2,3,2,Blocks.wooden_slab,8);bb.buildBlock(-2,3,3,Blocks.planks,4);
		bb.buildBlock(-2,3,4,Blocks.jungle_stairs,3);bb.buildBlock(-2,3,5,Blocks.wooden_slab,3);bb.buildBlock(-1,3,-5,Blocks.wooden_slab,3);
		...
		bb.buildBlock(0,3,-5,Blocks.wooden_slab,3);bb.buildBlock(0,3,-4,Blocks.jungle_stairs,2);bb.buildBlock(0,3,-3,Blocks.planks,4);
		bb.buildBlock(0,3,-2,Blocks.wooden_slab,8);bb.buildBlock(0,3,-1,Blocks.wooden_slab,8);bb.buildBlock(0,3,1,Blocks.wooden_slab,8);
		bb.buildBlock(0,3,2,Blocks.wooden_slab,8);bb.buildBlock(0,3,3,Blocks.planks,4);bb.buildBlock(0,3,4,Blocks.jungle_stairs,3);
		bb.buildBlock(0,3,5,Blocks.wooden_slab,3);bb.buildBlock(1,3,-5,Blocks.wooden_slab,3);bb.buildBlock(1,3,-4,Blocks.jungle_stairs,2);
		...
		bb.buildBlock(1,3,4,Blocks.jungle_stairs,3);bb.buildBlock(1,3,5,Blocks.wooden_slab,3);bb.buildBlock(2,3,-5,Blocks.wooden_slab,3);
		bb.buildBlock(2,3,-4,Blocks.jungle_stairs,2);bb.buildBlock(2,3,-3,Blocks.planks,4);bb.buildBlock(2,3,-2,Blocks.wooden_slab,8);
		...
		bb.buildBlock(2,3,2,Blocks.wooden_slab,8);bb.buildBlock(2,3,3,Blocks.planks,4);bb.buildBlock(2,3,4,Blocks.jungle_stairs,3);
		bb.buildBlock(2,3,5,Blocks.wooden_slab,3);bb.buildBlock(3,3,-3,Blocks.planks,4);bb.buildBlock(3,3,-2,Blocks.planks,4);
		bb.buildBlock(3,3,-1,Blocks.planks,4);bb.buildBlock(3,3,0,Blocks.planks,4);bb.buildBlock(3,3,1,Blocks.planks,4);
		bb.buildBlock(3,3,2,Blocks.planks,4);bb.buildBlock(3,3,3,Blocks.planks,4);bb.buildBlock(-3,4,-2,Blocks.planks,0);
		bb.buildBlock(-3,4,-1,Blocks.planks,0);bb.buildBlock(-3,4,0,Blocks.planks,0);bb.buildBlock(-3,4,1,Blocks.planks,0);
		bb.buildBlock(-3,4,2,Blocks.planks,0);bb.buildBlock(-2,4,-3,Blocks.planks,0);bb.buildBlock(-2,4,3,Blocks.planks,0);
		bb.buildBlock(-1,4,-3,Blocks.planks,0);bb.buildBlock(-1,4,3,Blocks.planks,0);bb.buildBlock(0,4,-3,Blocks.planks,0);
		bb.buildBlock(0,4,-2,Blocks.bed,3);bb.buildBlock(0,4,2,Blocks.bed,3);bb.buildBlock(0,4,3,Blocks.planks,0);
		bb.buildBlock(1,4,-3,Blocks.planks,0);bb.buildBlock(1,4,-2,Blocks.bed,11);bb.buildBlock(1,4,2,Blocks.bed,11);
		bb.buildBlock(1,4,3,Blocks.planks,0);bb.buildBlock(2,4,-3,Blocks.planks,0);bb.buildBlock(2,4,-2,Blocks.chest,4);
		bb.buildBlock(2,4,-1,Blocks.chest,4);bb.buildBlock(2,4,1,Blocks.chest,4);bb.buildBlock(2,4,2,Blocks.chest,4);
		bb.buildBlock(2,4,3,Blocks.planks,0);bb.buildBlock(3,4,-2,Blocks.planks,0);bb.buildBlock(3,4,-1,Blocks.planks,0);
		...
		bb.buildBlock(2,7,0,Blocks.torch,2);bb.buildBlock(2,7,2,Blocks.torch,2);
