...
public class BuildingFlowerShop extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(0,0,0,Blocks.flower_pot,0);bb.buildBlock(0,0,1,Blocks.jungle_stairs,1);bb.buildBlock(0,0,2,Blocks.stonebrick,0);
		bb.buildBlock(0,0,3,Blocks.double_plant,4);bb.buildBlock(1,0,-3,Blocks.double_plant,4);bb.buildBlock(1,0,-2,Blocks.stonebrick,0);
		bb.buildBlock(1,0,2,Blocks.stonebrick,0);bb.buildBlock(1,0,3,Blocks.double_plant,4);bb.buildBlock(2,0,-3,Blocks.double_plant,4);
		bb.buildBlock(2,0,-2,Blocks.stonebrick,0);bb.buildBlock(2,0,-1,Blocks.stonebrick,0);bb.buildBlock(2,0,0,Blocks.wooden_door,0);
		bb.buildBlock(2,0,1,Blocks.stonebrick,0);bb.buildBlock(2,0,2,Blocks.stonebrick,0);bb.buildBlock(2,0,3,Blocks.double_plant,4);
		bb.buildBlock(3,0,-3,Blocks.double_plant,4);bb.buildBlock(3,0,-2,Blocks.double_plant,4);bb.buildBlock(3,0,-1,Blocks.fence,0);
		bb.buildBlock(3,0,1,Blocks.fence,0);bb.buildBlock(3,0,2,Blocks.double_plant,4);bb.buildBlock(3,0,3,Blocks.double_plant,4);
		bb.buildBlock(-3,1,-3,Blocks.double_plant,8);bb.buildBlock(-3,1,-2,Blocks.double_plant,11);bb.buildBlock(-3,1,-1,Blocks.double_plant,10);
		bb.buildBlock(-3,1,0,Blocks.double_plant,11);bb.buildBlock(-3,1,1,Blocks.double_plant,11);bb.buildBlock(-3,1,2,Blocks.double_plant,10);
		bb.buildBlock(-3,1,3,Blocks.double_plant,10);bb.buildBlock(-2,1,-3,Blocks.double_plant,8);bb.buildBlock(-2,1,-2,Blocks.planks,3);
		bb.buildBlock(-2,1,-1,Blocks.glass_pane,0);bb.buildBlock(-2,1,0,Blocks.glass_pane,0);bb.buildBlock(-2,1,1,Blocks.glass_pane,0);
		bb.buildBlock(-2,1,2,Blocks.planks,3);bb.buildBlock(-2,1,3,Blocks.double_plant,10);bb.buildBlock(-1,1,-3,Blocks.double_plant,10);
		bb.buildBlock(-1,1,-2,Blocks.glass_pane,0);bb.buildBlock(-1,1,-1,Blocks.planks,3);bb.buildBlock(-1,1,0,Blocks.planks,3);
		bb.buildBlock(-1,1,1,Blocks.jungle_stairs,3);bb.buildBlock(-1,1,2,Blocks.glass_pane,0);bb.buildBlock(-1,1,3,Blocks.double_plant,10);
		bb.buildBlock(0,1,-3,Blocks.double_plant,10);bb.buildBlock(0,1,-2,Blocks.glass_pane,0);bb.buildBlock(0,1,2,Blocks.glass_pane,0);
		bb.buildBlock(0,1,3,Blocks.double_plant,10);bb.buildBlock(1,1,-3,Blocks.double_plant,10);bb.buildBlock(1,1,-2,Blocks.glass_pane,0);
		bb.buildBlock(1,1,2,Blocks.glass_pane,0);bb.buildBlock(1,1,3,Blocks.double_plant,10);bb.buildBlock(2,1,-3,Blocks.double_plant,10);
		bb.buildBlock(2,1,-2,Blocks.planks,3);bb.buildBlock(2,1,-1,Blocks.fence,0);bb.buildBlock(2,1,0,Blocks.wooden_door,8);
		bb.buildBlock(2,1,1,Blocks.fence,0);bb.buildBlock(2,1,2,Blocks.planks,3);bb.buildBlock(2,1,3,Blocks.double_plant,9);
		bb.buildBlock(3,1,-3,Blocks.double_plant,10);bb.buildBlock(3,1,-2,Blocks.double_plant,8);bb.buildBlock(3,1,2,Blocks.double_plant,11);
		bb.buildBlock(3,1,3,Blocks.double_plant,9);bb.buildBlock(-3,2,-2,Blocks.vine,8);bb.buildBlock(-3,2,2,Blocks.vine,8);
		bb.buildBlock(-2,2,-3,Blocks.vine,1);bb.buildBlock(-2,2,-2,Blocks.planks,3);bb.buildBlock(-2,2,-1,Blocks.glass_pane,0);
		bb.buildBlock(-2,2,0,Blocks.glass_pane,0);bb.buildBlock(-2,2,1,Blocks.glass_pane,0);bb.buildBlock(-2,2,2,Blocks.planks,3);
		bb.buildBlock(-2,2,3,Blocks.vine,4);bb.buildBlock(-1,2,-2,Blocks.glass_pane,0);bb.buildBlock(-1,2,-1,Blocks.planks,3);
		bb.buildBlock(-1,2,0,Blocks.jungle_stairs,3);bb.buildBlock(-1,2,2,Blocks.glass_pane,0);bb.buildBlock(0,2,-2,Blocks.glass_pane,0);
		bb.buildBlock(0,2,2,Blocks.glass_pane,0);bb.buildBlock(1,2,-2,Blocks.glass_pane,0);bb.buildBlock(1,2,2,Blocks.glass_pane,0);
		bb.buildBlock(2,2,-3,Blocks.vine,1);bb.buildBlock(2,2,-2,Blocks.planks,3);bb.buildBlock(2,2,-1,Blocks.planks,3);
		bb.buildBlock(2,2,0,Blocks.planks,3);bb.buildBlock(2,2,1,Blocks.planks,3);bb.buildBlock(2,2,2,Blocks.planks,3);
		bb.buildBlock(2,2,3,Blocks.vine,4);bb.buildBlock(3,2,-2,Blocks.vine,2);bb.buildBlock(3,2,2,Blocks.vine,2);
		bb.buildBlock(-3,3,-2,Blocks.vine,8);bb.buildBlock(-3,3,2,Blocks.vine,8);bb.buildBlock(-2,3,-3,Blocks.vine,1);
		bb.buildBlock(-2,3,-2,Blocks.planks,3);bb.buildBlock(-2,3,-1,Blocks.glass_pane,0);bb.buildBlock(-2,3,0,Blocks.glass_pane,0);
		bb.buildBlock(-2,3,1,Blocks.glass_pane,0);bb.buildBlock(-2,3,2,Blocks.planks,3);bb.buildBlock(-1,3,-2,Blocks.glass_pane,0);
		bb.buildBlock(-1,3,-1,Blocks.jungle_stairs,3);bb.buildBlock(-1,3,2,Blocks.glass_pane,0);bb.buildBlock(0,3,-2,Blocks.glass_pane,0);
		bb.buildBlock(0,3,2,Blocks.glass_pane,0);bb.buildBlock(1,3,-2,Blocks.glass_pane,0);bb.buildBlock(1,3,2,Blocks.glass_pane,0);
		bb.buildBlock(2,3,-2,Blocks.planks,3);bb.buildBlock(2,3,-1,Blocks.glass_pane,0);bb.buildBlock(2,3,0,Blocks.glass_pane,0);
		bb.buildBlock(2,3,1,Blocks.glass_pane,0);bb.buildBlock(2,3,2,Blocks.planks,3);bb.buildBlock(2,3,3,Blocks.vine,4);
		bb.buildBlock(3,3,-2,Blocks.vine,2);bb.buildBlock(-2,4,-2,Blocks.double_wooden_slab,3);bb.buildBlock(-2,4,-1,Blocks.double_wooden_slab,3);
		...
		bb.buildBlock(-1,4,-2,Blocks.double_wooden_slab,3);bb.buildBlock(-1,4,2,Blocks.double_wooden_slab,3);bb.buildBlock(0,4,-2,Blocks.double_wooden_slab,3);
		bb.buildBlock(0,4,-1,Blocks.wooden_slab,3);bb.buildBlock(0,4,0,Blocks.wooden_slab,3);bb.buildBlock(0,4,1,Blocks.wooden_slab,3);
		bb.buildBlock(0,4,2,Blocks.double_wooden_slab,3);bb.buildBlock(1,4,-2,Blocks.double_wooden_slab,3);bb.buildBlock(1,4,-1,Blocks.double_wooden_slab,3);
		bb.buildBlock(1,4,0,Blocks.double_wooden_slab,3);bb.buildBlock(1,4,1,Blocks.planks,3);bb.buildBlock(1,4,2,Blocks.double_wooden_slab,3);
		bb.buildBlock(2,4,-2,Blocks.double_wooden_slab,3);bb.buildBlock(2,4,-1,Blocks.double_wooden_slab,3);bb.buildBlock(2,4,0,Blocks.double_wooden_slab,3);
		bb.buildBlock(2,4,1,Blocks.double_wooden_slab,3);bb.buildBlock(2,4,2,Blocks.double_wooden_slab,3);bb.buildBlock(-2,5,-2,Blocks.planks,3);
		bb.buildBlock(-2,5,-1,Blocks.glass_pane,0);bb.buildBlock(-2,5,0,Blocks.glass_pane,0);bb.buildBlock(-2,5,1,Blocks.glass_pane,0);
		bb.buildBlock(-2,5,2,Blocks.planks,3);bb.buildBlock(-1,5,-2,Blocks.glass_pane,0);bb.buildBlock(-1,5,2,Blocks.glass_pane,0);
		bb.buildBlock(0,5,-2,Blocks.glass_pane,0);bb.buildBlock(0,5,2,Blocks.glass_pane,0);bb.buildBlock(1,5,-2,Blocks.glass_pane,0);
		bb.buildBlock(1,5,-1,Blocks.bed,10);bb.buildBlock(1,5,0,Blocks.bed,2);bb.buildBlock(1,5,1,Blocks.flower_pot,7);
		...
		bb.buildBlock(2,9,-2,Blocks.torch,5);bb.buildBlock(2,9,2,Blocks.torch,5);
