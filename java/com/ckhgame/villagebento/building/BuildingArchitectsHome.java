...
public class BuildingArchitectsHome extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-3,0,3,Blocks.planks,0);bb.buildBlock(-2,0,-3,Blocks.fence,0);bb.buildBlock(-2,0,-2,Blocks.planks,1);
		bb.buildBlock(-2,0,0,Blocks.sandstone,0);bb.buildBlock(-2,0,3,Blocks.fence,0);bb.buildBlock(-1,0,-3,Blocks.fence,0);
		bb.buildBlock(-1,0,0,Blocks.planks,4);bb.buildBlock(-1,0,2,Blocks.planks,0);bb.buildBlock(-1,0,3,Blocks.fence,0);
		bb.buildBlock(0,0,-3,Blocks.fence,0);bb.buildBlock(0,0,0,Blocks.planks,3);bb.buildBlock(0,0,3,Blocks.fence,0);
		bb.buildBlock(1,0,-3,Blocks.fence,0);bb.buildBlock(1,0,-2,Blocks.glass,0);bb.buildBlock(1,0,0,Blocks.oak_stairs,1);
		bb.buildBlock(1,0,2,Blocks.stonebrick,1);bb.buildBlock(1,0,3,Blocks.fence,0);bb.buildBlock(2,0,-3,Blocks.fence,0);
		bb.buildBlock(2,0,3,Blocks.fence,0);bb.buildBlock(3,0,-3,Blocks.planks,0);bb.buildBlock(3,0,-2,Blocks.fence,0);
		bb.buildBlock(3,0,-1,Blocks.fence,0);bb.buildBlock(3,0,0,Blocks.fence_gate,1);bb.buildBlock(3,0,1,Blocks.fence,0);
		bb.buildBlock(3,0,2,Blocks.fence,0);bb.buildBlock(3,0,3,Blocks.planks,0);bb.buildBlock(-3,1,-3,Blocks.planks,0);
		bb.buildBlock(-3,1,3,Blocks.planks,0);bb.buildBlock(-2,1,0,Blocks.stonebrick,0);bb.buildBlock(-1,1,0,Blocks.planks,2);
		bb.buildBlock(0,1,0,Blocks.oak_stairs,1);bb.buildBlock(3,1,-3,Blocks.planks,0);bb.buildBlock(3,1,-1,Blocks.fence,0);
		bb.buildBlock(3,1,1,Blocks.fence,0);bb.buildBlock(3,1,3,Blocks.planks,0);bb.buildBlock(-3,2,-3,Blocks.planks,0);
		bb.buildBlock(-3,2,3,Blocks.planks,0);bb.buildBlock(-2,2,0,Blocks.planks,5);bb.buildBlock(-1,2,0,Blocks.oak_stairs,1);
		bb.buildBlock(3,2,-3,Blocks.planks,0);bb.buildBlock(3,2,-1,Blocks.fence,0);bb.buildBlock(3,2,1,Blocks.fence,0);
		...
		bb.buildBlock(1,5,3,Blocks.glass_pane,0);bb.buildBlock(2,5,-3,Blocks.planks,2);bb.buildBlock(2,5,2,Blocks.flower_pot,3);
