...
public class BuildingSmallMilitaryCamp extends Building {
	...
	protected void generateVillagers(BuildingBuilder bb) {
		...
		//add villager
		bb.addBuildingVillager(VillagerSoldier.class,NameGenerator.getRandomMaleName(),0,0);
		bb.addBuildingVillager(VillagerSoldier.class,NameGenerator.getRandomMaleName(),-1,0);
	}
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(1,2,3,Blocks.glass_pane,0);bb.buildBlock(2,2,-3,Blocks.stonebrick,0);bb.buildBlock(2,2,-2,Blocks.stonebrick,0);
		bb.buildBlock(2,2,2,Blocks.stonebrick,0);bb.buildBlock(2,2,3,Blocks.stonebrick,0);bb.buildBlock(3,2,-3,Blocks.stonebrick,0);
		...
		bb.buildBlock(-3,4,3,Blocks.stonebrick,0);bb.buildBlock(-2,4,-3,Blocks.stonebrick,0);bb.buildBlock(-2,4,3,Blocks.stonebrick,0);
		bb.buildBlock(-1,4,-3,Blocks.stonebrick,0);bb.buildBlock(-1,4,3,Blocks.stonebrick,0);bb.buildBlock(0,4,-3,Blocks.stonebrick,0);
		bb.buildBlock(0,4,3,Blocks.stonebrick,0);bb.buildBlock(1,4,-3,Blocks.stonebrick,0);bb.buildBlock(1,4,3,Blocks.stonebrick,0);
		bb.buildBlock(2,4,-3,Blocks.stonebrick,0);bb.buildBlock(2,4,3,Blocks.stonebrick,0);bb.buildBlock(3,4,-3,Blocks.stonebrick,0);
		...
		bb.buildBlock(-3,5,-3,Blocks.stone_brick_stairs,2);bb.buildBlock(-3,5,-2,Blocks.stone_brick_stairs,0);bb.buildBlock(-3,5,-1,Blocks.stone_brick_stairs,0);
		bb.buildBlock(-3,5,0,Blocks.stone_brick_stairs,0);bb.buildBlock(-3,5,1,Blocks.stone_brick_stairs,0);bb.buildBlock(-3,5,2,Blocks.stone_brick_stairs,0);
		bb.buildBlock(-3,5,3,Blocks.stone_brick_stairs,3);bb.buildBlock(-2,5,-3,Blocks.stone_brick_stairs,2);bb.buildBlock(-2,5,-2,Blocks.stone_slab,5);
		bb.buildBlock(-2,5,-1,Blocks.stone_slab,5);bb.buildBlock(-2,5,0,Blocks.stone_slab,5);bb.buildBlock(-2,5,1,Blocks.stone_slab,5);
		bb.buildBlock(-2,5,2,Blocks.stone_slab,5);bb.buildBlock(-2,5,3,Blocks.stone_brick_stairs,3);bb.buildBlock(-1,5,-3,Blocks.stone_brick_stairs,2);
		...
		bb.buildBlock(0,5,-3,Blocks.stone_brick_stairs,2);bb.buildBlock(0,5,-2,Blocks.stone_slab,5);bb.buildBlock(0,5,-1,Blocks.planks,0);
		bb.buildBlock(0,5,0,Blocks.planks,0);bb.buildBlock(0,5,1,Blocks.planks,0);bb.buildBlock(0,5,2,Blocks.stone_slab,5);
		bb.buildBlock(0,5,3,Blocks.stone_brick_stairs,3);bb.buildBlock(1,5,-3,Blocks.stone_brick_stairs,2);bb.buildBlock(1,5,-2,Blocks.stone_slab,5);
		bb.buildBlock(1,5,-1,Blocks.planks,0);bb.buildBlock(1,5,0,Blocks.planks,0);bb.buildBlock(1,5,1,Blocks.planks,0);
		bb.buildBlock(1,5,2,Blocks.stone_slab,5);bb.buildBlock(1,5,3,Blocks.stone_brick_stairs,3);bb.buildBlock(2,5,-3,Blocks.stone_brick_stairs,2);
		...
		bb.buildBlock(3,5,-3,Blocks.stone_brick_stairs,1);bb.buildBlock(3,5,-2,Blocks.stone_brick_stairs,1);bb.buildBlock(3,5,-1,Blocks.stone_brick_stairs,1);
		bb.buildBlock(3,5,0,Blocks.stone_brick_stairs,1);bb.buildBlock(3,5,1,Blocks.stone_brick_stairs,1);bb.buildBlock(3,5,2,Blocks.stone_brick_stairs,1);
		bb.buildBlock(3,5,3,Blocks.stone_brick_stairs,3);bb.buildBlock(3,0,-2,Blocks.torch,5);bb.buildBlock(3,0,2,Blocks.torch,5);
		...
		bb.buildBlock(2,4,0,Blocks.torch,2);bb.buildBlock(2,4,2,Blocks.torch,2);bb.addEntityItemFrame(2,1,2,3,ModBlocks.blockSmallMilitaryCamp);
	}
