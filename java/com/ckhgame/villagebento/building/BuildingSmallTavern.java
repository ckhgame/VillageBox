...
public class BuildingSmallTavern extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		bb.buildBlock(-2,-4,-2,Blocks.chest,5);bb.buildBlock(-2,-4,-1,Blocks.bed,0);bb.buildBlock(-2,-4,0,Blocks.bed,8);
		bb.buildBlock(-2,-4,3,Blocks.monster_egg,2);bb.buildBlock(-1,-4,-2,Blocks.air,0);bb.buildBlock(-1,-4,-1,Blocks.air,0);
		bb.buildBlock(-1,-4,0,Blocks.air,0);bb.buildBlock(0,-4,-2,Blocks.air,0);bb.buildBlock(0,-4,-1,Blocks.air,0);
		bb.buildBlock(0,-4,0,Blocks.air,0);bb.buildBlock(0,-4,1,Blocks.spruce_stairs,1);bb.buildBlock(0,-4,2,Blocks.spruce_stairs,1);
		bb.buildBlock(1,-4,-2,Blocks.air,0);bb.buildBlock(1,-4,0,Blocks.air,0);bb.buildBlock(1,-4,1,Blocks.air,0);
		bb.buildBlock(1,-4,2,Blocks.air,0);bb.buildBlock(2,-4,-2,Blocks.air,0);bb.buildBlock(2,-4,-1,Blocks.air,0);
		bb.buildBlock(2,-4,0,Blocks.air,0);bb.buildBlock(2,-4,1,Blocks.air,0);bb.buildBlock(2,-4,2,Blocks.air,0);
		bb.buildBlock(-3,-3,-2,Blocks.monster_egg,2);bb.buildBlock(-2,-3,-2,Blocks.air,0);bb.buildBlock(-2,-3,-1,Blocks.air,0);
		bb.buildBlock(-2,-3,0,Blocks.air,0);bb.buildBlock(-2,-3,3,Blocks.monster_egg,2);bb.buildBlock(-1,-3,-2,Blocks.air,0);
		bb.buildBlock(-1,-3,-1,Blocks.air,0);bb.buildBlock(-1,-3,0,Blocks.air,0);bb.buildBlock(-1,-3,1,Blocks.spruce_stairs,1);
		bb.buildBlock(-1,-3,2,Blocks.spruce_stairs,1);bb.buildBlock(0,-3,-2,Blocks.air,0);bb.buildBlock(0,-3,-1,Blocks.air,0);
		...
		bb.buildBlock(1,-3,1,Blocks.air,0);bb.buildBlock(1,-3,2,Blocks.air,0);bb.buildBlock(2,-3,-2,Blocks.air,0);
		bb.buildBlock(2,-3,-1,Blocks.air,0);bb.buildBlock(2,-3,0,Blocks.air,0);bb.buildBlock(2,-3,1,Blocks.air,0);
		bb.buildBlock(2,-3,2,Blocks.air,0);bb.buildBlock(-2,-2,-2,Blocks.air,0);bb.buildBlock(-2,-2,-1,Blocks.air,0);
		bb.buildBlock(-2,-2,0,Blocks.air,0);bb.buildBlock(-2,-2,1,Blocks.spruce_stairs,1);bb.buildBlock(-2,-2,2,Blocks.spruce_stairs,1);
		bb.buildBlock(-1,-2,-1,Blocks.air,0);bb.buildBlock(-1,-2,0,Blocks.air,0);bb.buildBlock(-1,-2,1,Blocks.air,0);
		bb.buildBlock(-1,-2,2,Blocks.air,0);bb.buildBlock(0,-2,-2,Blocks.air,0);bb.buildBlock(0,-2,-1,Blocks.air,0);
		bb.buildBlock(0,-2,0,Blocks.air,0);bb.buildBlock(0,-2,1,Blocks.air,0);bb.buildBlock(0,-2,2,Blocks.air,0);
		bb.buildBlock(1,-2,-2,Blocks.air,0);bb.buildBlock(1,-2,-1,Blocks.air,0);bb.buildBlock(1,-2,0,Blocks.air,0);
		bb.buildBlock(1,-2,1,Blocks.air,0);bb.buildBlock(1,-2,2,Blocks.air,0);bb.buildBlock(2,-2,-1,Blocks.air,0);
		bb.buildBlock(2,-2,1,Blocks.air,0);bb.buildBlock(-2,-1,0,Blocks.stone_slab,5);bb.buildBlock(-2,-1,1,Blocks.air,0);
		bb.buildBlock(-2,-1,2,Blocks.air,0);bb.buildBlock(-1,-1,0,Blocks.stone_slab,5);bb.buildBlock(-1,-1,1,Blocks.air,0);
		bb.buildBlock(-1,-1,2,Blocks.air,0);bb.buildBlock(0,-1,0,Blocks.stone_slab,5);bb.buildBlock(0,-1,1,Blocks.air,0);
		bb.buildBlock(0,-1,2,Blocks.air,0);bb.buildBlock(-3,0,-3,Blocks.planks,1);bb.buildBlock(-3,0,-2,Blocks.planks,1);
		...
		bb.buildBlock(-2,0,3,Blocks.planks,1);bb.buildBlock(-1,0,-3,Blocks.planks,1);bb.buildBlock(-1,0,-1,Blocks.planks,1);
		bb.buildBlock(-1,0,3,Blocks.planks,1);bb.buildBlock(0,0,-3,Blocks.planks,1);bb.buildBlock(0,0,-1,Blocks.planks,1);
		bb.buildBlock(0,0,3,Blocks.planks,1);bb.buildBlock(1,0,-3,Blocks.planks,1);bb.buildBlock(1,0,-1,Blocks.planks,1);
		bb.buildBlock(1,0,2,Blocks.spruce_stairs,2);bb.buildBlock(1,0,3,Blocks.planks,1);bb.buildBlock(2,0,-3,Blocks.planks,1);
		bb.buildBlock(2,0,-1,Blocks.planks,1);bb.buildBlock(2,0,2,Blocks.spruce_stairs,2);bb.buildBlock(2,0,3,Blocks.planks,1);
		bb.buildBlock(3,0,-3,Blocks.planks,1);bb.buildBlock(3,0,-2,Blocks.planks,1);bb.buildBlock(3,0,-1,Blocks.planks,1);
		bb.buildBlock(3,0,0,Blocks.wooden_door,4);bb.buildBlock(3,0,1,Blocks.planks,1);bb.buildBlock(3,0,2,Blocks.planks,1);
		bb.buildBlock(3,0,3,Blocks.planks,1);bb.buildBlock(-3,1,-3,Blocks.planks,1);bb.buildBlock(-3,1,-2,Blocks.planks,1);
		bb.buildBlock(-3,1,-1,Blocks.glass_pane,0);bb.buildBlock(-3,1,0,Blocks.planks,1);bb.buildBlock(-3,1,1,Blocks.glass_pane,0);
		bb.buildBlock(-3,1,2,Blocks.planks,1);bb.buildBlock(-3,1,3,Blocks.planks,1);bb.buildBlock(-2,1,-3,Blocks.planks,1);
		...
		bb.buildBlock(1,1,3,Blocks.glass_pane,0);bb.buildBlock(2,1,-3,Blocks.planks,1);bb.buildBlock(2,1,3,Blocks.planks,1);
		bb.buildBlock(3,1,-3,Blocks.planks,1);bb.buildBlock(3,1,-2,Blocks.glass_pane,0);bb.buildBlock(3,1,-1,Blocks.planks,1);
		bb.buildBlock(3,1,0,Blocks.wooden_door,8);bb.buildBlock(3,1,1,Blocks.planks,1);bb.buildBlock(3,1,2,Blocks.glass_pane,0);
		...
		bb.buildBlock(1,2,3,Blocks.glass_pane,0);bb.buildBlock(2,2,-3,Blocks.planks,1);bb.buildBlock(2,2,3,Blocks.planks,1);
		bb.buildBlock(3,2,-3,Blocks.planks,1);bb.buildBlock(3,2,-2,Blocks.glass_pane,0);bb.buildBlock(3,2,-1,Blocks.planks,1);
		bb.buildBlock(3,2,0,Blocks.planks,1);bb.buildBlock(3,2,1,Blocks.planks,1);bb.buildBlock(3,2,2,Blocks.glass_pane,0);
		...
		bb.buildBlock(1,3,3,Blocks.planks,1);bb.buildBlock(2,3,-3,Blocks.planks,1);bb.buildBlock(2,3,3,Blocks.planks,1);
		...
		bb.buildBlock(2,5,1,Blocks.dark_oak_stairs,1);bb.buildBlock(2,5,2,Blocks.dark_oak_stairs,3);bb.buildBlock(-1,-2,-2,Blocks.torch,3);
		bb.buildBlock(2,-2,-2,Blocks.torch,2);bb.buildBlock(2,-2,0,Blocks.torch,2);bb.buildBlock(2,-2,2,Blocks.torch,2);
		...
		bb.buildBlock(2,3,0,Blocks.torch,2);bb.buildBlock(2,3,2,Blocks.torch,2);
