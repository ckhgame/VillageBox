...
public class BuildingChickenShop extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(2,0,-3,Blocks.planks,2);bb.buildBlock(2,0,-2,Blocks.furnace,3);bb.buildBlock(2,0,0,Blocks.carpet,14);bb.buildBlock(2,0,2,Blocks.bookshelf,0);bb.buildBlock(2,0,3,Blocks.planks,2);
		bb.buildBlock(3,0,-2,Blocks.planks,2);bb.buildBlock(3,0,-1,Blocks.planks,2);bb.buildBlock(3,0,0,Blocks.wooden_door,0);
		bb.buildBlock(3,0,1,Blocks.planks,2);bb.buildBlock(3,0,2,Blocks.planks,2);bb.buildBlock(-3,1,-2,Blocks.planks,2);
		...
		bb.buildBlock(1,1,3,Blocks.planks,2);bb.buildBlock(2,1,-3,Blocks.planks,2);bb.buildBlock(2,1,2,Blocks.bookshelf,0);
		...
		bb.buildBlock(2,2,2,Blocks.bookshelf,0);bb.buildBlock(2,2,3,Blocks.planks,2);bb.buildBlock(3,2,-2,Blocks.planks,2);
		...
		bb.buildBlock(-2,3,-3,Blocks.planks,2);bb.buildBlock(-2,3,3,Blocks.planks,2);bb.buildBlock(-1,3,-3,Blocks.planks,2);
		bb.buildBlock(-1,3,3,Blocks.planks,2);bb.buildBlock(0,3,-3,Blocks.planks,2);bb.buildBlock(0,3,3,Blocks.planks,2);
		bb.buildBlock(1,3,-3,Blocks.planks,2);bb.buildBlock(1,3,3,Blocks.planks,2);bb.buildBlock(2,3,-3,Blocks.planks,2);
		bb.buildBlock(2,3,3,Blocks.planks,2);bb.buildBlock(3,3,-2,Blocks.planks,2);bb.buildBlock(3,3,-1,Blocks.planks,2);
		bb.buildBlock(3,3,0,Blocks.planks,2);bb.buildBlock(3,3,1,Blocks.planks,2);bb.buildBlock(3,3,2,Blocks.planks,2);
		bb.buildBlock(-2,4,-2,Blocks.acacia_stairs,0);bb.buildBlock(-2,4,-1,Blocks.acacia_stairs,0);bb.buildBlock(-2,4,0,Blocks.acacia_stairs,0);
		bb.buildBlock(-2,4,1,Blocks.acacia_stairs,0);bb.buildBlock(-2,4,2,Blocks.acacia_stairs,0);bb.buildBlock(-1,4,-2,Blocks.acacia_stairs,2);
		bb.buildBlock(-1,4,-1,Blocks.wooden_slab,2);bb.buildBlock(-1,4,0,Blocks.wooden_slab,2);bb.buildBlock(-1,4,1,Blocks.wooden_slab,2);
		bb.buildBlock(-1,4,2,Blocks.acacia_stairs,3);bb.buildBlock(0,4,-2,Blocks.acacia_stairs,2);bb.buildBlock(0,4,-1,Blocks.wooden_slab,2);
		bb.buildBlock(0,4,0,Blocks.wooden_slab,2);bb.buildBlock(0,4,1,Blocks.wooden_slab,2);bb.buildBlock(0,4,2,Blocks.acacia_stairs,3);
		...
		bb.buildBlock(1,4,1,Blocks.wooden_slab,2);bb.buildBlock(1,4,2,Blocks.acacia_stairs,3);bb.buildBlock(2,4,-2,Blocks.acacia_stairs,1);
		bb.buildBlock(2,4,-1,Blocks.acacia_stairs,1);bb.buildBlock(2,4,0,Blocks.acacia_stairs,1);bb.buildBlock(2,4,1,Blocks.acacia_stairs,1);
		bb.buildBlock(2,4,2,Blocks.acacia_stairs,1);bb.buildBlock(-3,0,-3,Blocks.torch,5);bb.buildBlock(-3,0,3,Blocks.torch,5);
		...
		bb.buildBlock(2,3,-2,Blocks.torch,2);bb.buildBlock(2,3,2,Blocks.torch,2);bb.addEntityPainting(-3,2,0,3,"Wasteland");
