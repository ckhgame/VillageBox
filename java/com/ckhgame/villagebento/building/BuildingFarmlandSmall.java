...
public class BuildingFarmlandSmall extends Building {
	...
	protected void generateVillagers(BuildingBuilder bb) {
		...
		//add villager
		bb.addBuildingVillager(VillagerFarmerSmall.class,NameGenerator.getRandomMaleName(),0,0);
	}
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(1,-1,-2,Blocks.farmland,7);bb.buildBlock(1,-1,-1,Blocks.water,0);bb.buildBlock(1,-1,0,Blocks.grass,0);
		...
		bb.buildBlock(2,-1,-1,Blocks.water,0);bb.buildBlock(2,-1,0,Blocks.grass,0);bb.buildBlock(2,-1,1,Blocks.grass,0);
		...
		bb.buildBlock(3,-1,-3,Blocks.water,0);bb.buildBlock(3,-1,-2,Blocks.farmland,7);bb.buildBlock(3,-1,-1,Blocks.water,0);
		...
		bb.buildBlock(4,-1,-2,Blocks.grass,0);bb.buildBlock(4,-1,-1,Blocks.grass,0);bb.buildBlock(4,-1,0,Blocks.dirt,0);
		bb.buildBlock(4,-1,1,Blocks.dirt,0);bb.buildBlock(4,-1,2,Blocks.grass,0);bb.buildBlock(4,-1,3,Blocks.grass,0);
		...
		bb.buildBlock(1,0,-3,Blocks.fence,0);bb.buildBlock(1,0,-2,Blocks.wheat,4);bb.buildBlock(1,0,-1,Blocks.fence,0);
		bb.buildBlock(1,0,5,Blocks.fence,0);bb.buildBlock(2,0,-5,Blocks.fence,0);bb.buildBlock(2,0,-2,Blocks.wheat,3);
		bb.buildBlock(2,0,5,Blocks.fence,0);bb.buildBlock(3,0,-5,Blocks.fence,0);bb.buildBlock(3,0,-3,Blocks.fence,0);
		bb.buildBlock(3,0,-2,Blocks.wheat,7);bb.buildBlock(3,0,-1,Blocks.fence,0);bb.buildBlock(3,0,5,Blocks.fence,0);
		bb.buildBlock(4,0,-5,Blocks.fence,0);bb.buildBlock(4,0,0,Blocks.fence,0);bb.buildBlock(4,0,1,Blocks.planks,0);
		bb.buildBlock(4,0,2,Blocks.wooden_door,0);bb.buildBlock(4,0,3,Blocks.planks,0);bb.buildBlock(4,0,4,Blocks.fence,0);
		...
		bb.buildBlock(5,0,0,Blocks.fence,0);bb.buildBlock(5,0,4,Blocks.fence,0);bb.buildBlock(5,0,5,Blocks.fence,0);
		bb.buildBlock(-5,1,-4,Blocks.planks,2);bb.buildBlock(-5,1,-3,Blocks.planks,2);bb.buildBlock(-5,1,-2,Blocks.planks,2);
		bb.buildBlock(-5,1,-1,Blocks.planks,2);bb.buildBlock(-5,1,0,Blocks.planks,2);bb.buildBlock(-5,1,1,Blocks.planks,2);
		bb.buildBlock(-5,1,2,Blocks.planks,2);bb.buildBlock(-5,1,3,Blocks.planks,2);bb.buildBlock(-5,1,4,Blocks.planks,2);
		bb.buildBlock(-4,1,-2,Blocks.hay_block,4);bb.buildBlock(-4,1,-1,Blocks.planks,2);bb.buildBlock(-4,1,4,Blocks.planks,2);
		bb.buildBlock(-3,1,-2,Blocks.hay_block,0);bb.buildBlock(-3,1,-1,Blocks.planks,2);bb.buildBlock(-3,1,4,Blocks.glass_pane,0);
		bb.buildBlock(-2,1,-1,Blocks.planks,2);bb.buildBlock(-2,1,0,Blocks.flower_pot,8);bb.addTileEntityPot(-2,1,0,38,8);
		...
		bb.buildBlock(1,1,-1,Blocks.wooden_slab,1);bb.buildBlock(2,1,-3,Blocks.wooden_slab,1);bb.buildBlock(2,1,-1,Blocks.wooden_slab,1);
		bb.buildBlock(3,1,-3,Blocks.wooden_slab,1);bb.buildBlock(3,1,-2,Blocks.wooden_slab,1);bb.buildBlock(3,1,-1,Blocks.wooden_slab,1);
		bb.buildBlock(4,1,1,Blocks.planks,0);bb.buildBlock(4,1,2,Blocks.wooden_door,8);bb.buildBlock(4,1,3,Blocks.planks,0);
		bb.buildBlock(-5,2,-4,Blocks.wooden_slab,9);bb.buildBlock(-5,2,-3,Blocks.wooden_slab,9);bb.buildBlock(-5,2,-2,Blocks.wooden_slab,9);
		bb.buildBlock(-5,2,-1,Blocks.planks,2);bb.buildBlock(-5,2,0,Blocks.planks,2);bb.buildBlock(-5,2,1,Blocks.planks,2);
		bb.buildBlock(-5,2,2,Blocks.planks,2);bb.buildBlock(-5,2,3,Blocks.planks,2);bb.buildBlock(-5,2,4,Blocks.planks,2);
		bb.buildBlock(-4,2,-4,Blocks.wooden_slab,9);bb.buildBlock(-4,2,-3,Blocks.wooden_slab,9);bb.buildBlock(-4,2,-2,Blocks.wooden_slab,9);
		bb.buildBlock(-4,2,-1,Blocks.planks,2);bb.buildBlock(-4,2,4,Blocks.planks,2);bb.buildBlock(-3,2,-4,Blocks.wooden_slab,9);
		bb.buildBlock(-3,2,-3,Blocks.wooden_slab,9);bb.buildBlock(-3,2,-2,Blocks.wooden_slab,9);bb.buildBlock(-3,2,-1,Blocks.planks,2);
		bb.buildBlock(-3,2,4,Blocks.planks,2);bb.buildBlock(-2,2,-4,Blocks.wooden_slab,9);bb.buildBlock(-2,2,-3,Blocks.wooden_slab,9);
		bb.buildBlock(-2,2,-2,Blocks.wooden_slab,9);bb.buildBlock(-2,2,-1,Blocks.planks,2);bb.buildBlock(-2,2,4,Blocks.planks,2);
		bb.buildBlock(-1,2,-3,Blocks.wooden_slab,9);bb.buildBlock(-1,2,-2,Blocks.wooden_slab,9);bb.buildBlock(-1,2,-1,Blocks.planks,2);
		bb.buildBlock(-1,2,0,Blocks.planks,2);bb.buildBlock(-1,2,1,Blocks.planks,2);bb.buildBlock(-1,2,2,Blocks.planks,2);
		bb.buildBlock(-1,2,3,Blocks.planks,2);bb.buildBlock(-1,2,4,Blocks.planks,2);bb.buildBlock(4,2,1,Blocks.wooden_slab,2);
		bb.buildBlock(4,2,2,Blocks.wooden_slab,2);bb.buildBlock(4,2,3,Blocks.wooden_slab,2);bb.buildBlock(-5,3,-1,Blocks.spruce_stairs,2);
		bb.buildBlock(-5,3,0,Blocks.spruce_stairs,0);bb.buildBlock(-5,3,1,Blocks.spruce_stairs,0);bb.buildBlock(-5,3,2,Blocks.spruce_stairs,0);
		bb.buildBlock(-5,3,3,Blocks.spruce_stairs,0);bb.buildBlock(-5,3,4,Blocks.spruce_stairs,0);bb.buildBlock(-4,3,-1,Blocks.spruce_stairs,2);
		bb.buildBlock(-4,3,0,Blocks.wooden_slab,9);bb.buildBlock(-4,3,1,Blocks.wooden_slab,9);bb.buildBlock(-4,3,2,Blocks.wooden_slab,9);
		bb.buildBlock(-4,3,3,Blocks.wooden_slab,9);bb.buildBlock(-4,3,4,Blocks.spruce_stairs,3);bb.buildBlock(-3,3,-1,Blocks.spruce_stairs,2);
		bb.buildBlock(-3,3,0,Blocks.wooden_slab,9);bb.buildBlock(-3,3,1,Blocks.wooden_slab,9);bb.buildBlock(-3,3,2,Blocks.wooden_slab,9);
		bb.buildBlock(-3,3,3,Blocks.wooden_slab,9);bb.buildBlock(-3,3,4,Blocks.spruce_stairs,3);bb.buildBlock(-2,3,-1,Blocks.spruce_stairs,2);
		bb.buildBlock(-2,3,0,Blocks.wooden_slab,9);bb.buildBlock(-2,3,1,Blocks.wooden_slab,9);bb.buildBlock(-2,3,2,Blocks.wooden_slab,9);
		bb.buildBlock(-2,3,3,Blocks.wooden_slab,9);bb.buildBlock(-2,3,4,Blocks.spruce_stairs,3);bb.buildBlock(-1,3,-1,Blocks.spruce_stairs,2);
		bb.buildBlock(-1,3,0,Blocks.spruce_stairs,1);bb.buildBlock(-1,3,1,Blocks.spruce_stairs,1);bb.buildBlock(-1,3,2,Blocks.spruce_stairs,1);
		bb.buildBlock(-1,3,3,Blocks.spruce_stairs,1);bb.buildBlock(-1,3,4,Blocks.spruce_stairs,3);bb.buildBlock(-5,1,-5,Blocks.torch,5);
		bb.buildBlock(-5,1,5,Blocks.torch,5);bb.buildBlock(-4,1,-3,Blocks.torch,1);bb.buildBlock(-2,1,-5,Blocks.torch,5);
		bb.buildBlock(-2,1,-2,Blocks.torch,4);bb.buildBlock(-1,1,5,Blocks.torch,5);bb.buildBlock(0,1,1,Blocks.torch,1);
		bb.buildBlock(0,1,3,Blocks.torch,1);bb.buildBlock(1,1,-5,Blocks.torch,5);bb.buildBlock(2,1,5,Blocks.torch,5);
