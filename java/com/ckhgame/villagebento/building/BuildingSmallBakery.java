...
public class BuildingSmallBakery extends Building {
	...
	protected void generateVillagers(BuildingBuilder bb) {
		...
		//add villager
		bb.addBuildingVillager(VillagerNoviceBaker.class,NameGenerator.getRandomFemaleName(),0,0);
	}
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-1,1,-2,Blocks.planks,0);bb.buildBlock(-1,1,-1,Blocks.fence,0);bb.buildBlock(-1,1,0,Blocks.fence,0);
		...
		bb.buildBlock(-1,2,1,Blocks.planks,0);bb.buildBlock(-1,2,3,Blocks.glass_pane,0);bb.buildBlock(0,2,-3,Blocks.planks,0);
		bb.buildBlock(0,2,3,Blocks.planks,0);bb.buildBlock(1,2,-3,Blocks.glass_pane,0);bb.buildBlock(1,2,3,Blocks.glass_pane,0);
		bb.buildBlock(2,2,-3,Blocks.planks,0);bb.buildBlock(2,2,3,Blocks.planks,0);bb.buildBlock(3,2,-2,Blocks.planks,0);
		bb.buildBlock(3,2,-1,Blocks.planks,0);bb.buildBlock(3,2,0,Blocks.planks,0);bb.buildBlock(3,2,1,Blocks.planks,0);
		bb.buildBlock(3,2,2,Blocks.planks,0);bb.buildBlock(-3,3,-2,Blocks.planks,0);bb.buildBlock(-3,3,-1,Blocks.planks,0);
		bb.buildBlock(-3,3,0,Blocks.planks,0);bb.buildBlock(-3,3,1,Blocks.planks,0);bb.buildBlock(-3,3,2,Blocks.planks,0);
		bb.buildBlock(-2,3,-3,Blocks.planks,0);bb.buildBlock(-2,3,3,Blocks.planks,0);bb.buildBlock(-1,3,-3,Blocks.planks,0);
		bb.buildBlock(-1,3,-2,Blocks.planks,0);bb.buildBlock(-1,3,-1,Blocks.planks,0);bb.buildBlock(-1,3,0,Blocks.planks,0);
		bb.buildBlock(-1,3,1,Blocks.planks,0);bb.buildBlock(-1,3,3,Blocks.planks,0);bb.buildBlock(0,3,-3,Blocks.planks,0);
		bb.buildBlock(0,3,3,Blocks.planks,0);bb.buildBlock(1,3,-3,Blocks.planks,0);bb.buildBlock(1,3,3,Blocks.planks,0);
		bb.buildBlock(2,3,-3,Blocks.planks,0);bb.buildBlock(2,3,3,Blocks.planks,0);bb.buildBlock(3,3,-2,Blocks.planks,0);
		bb.buildBlock(3,3,-1,Blocks.planks,0);bb.buildBlock(3,3,0,Blocks.planks,0);bb.buildBlock(3,3,1,Blocks.planks,0);
		bb.buildBlock(3,3,2,Blocks.planks,0);bb.buildBlock(-3,4,-2,Blocks.spruce_stairs,0);bb.buildBlock(-3,4,-1,Blocks.spruce_stairs,0);
		bb.buildBlock(-3,4,0,Blocks.spruce_stairs,0);bb.buildBlock(-3,4,1,Blocks.spruce_stairs,0);bb.buildBlock(-3,4,2,Blocks.spruce_stairs,0);
		bb.buildBlock(-2,4,-3,Blocks.spruce_stairs,2);bb.buildBlock(-2,4,-2,Blocks.planks,1);bb.buildBlock(-2,4,-1,Blocks.planks,1);
		bb.buildBlock(-2,4,0,Blocks.planks,1);bb.buildBlock(-2,4,1,Blocks.planks,1);bb.buildBlock(-2,4,2,Blocks.planks,1);
		bb.buildBlock(-2,4,3,Blocks.spruce_stairs,3);bb.buildBlock(-1,4,-3,Blocks.spruce_stairs,2);bb.buildBlock(-1,4,-2,Blocks.planks,1);
		bb.buildBlock(-1,4,-1,Blocks.planks,0);bb.buildBlock(-1,4,0,Blocks.planks,0);bb.buildBlock(-1,4,1,Blocks.planks,0);
		bb.buildBlock(-1,4,2,Blocks.planks,1);bb.buildBlock(-1,4,3,Blocks.spruce_stairs,3);bb.buildBlock(0,4,-3,Blocks.spruce_stairs,2);
		bb.buildBlock(0,4,-2,Blocks.planks,1);bb.buildBlock(0,4,-1,Blocks.planks,0);bb.buildBlock(0,4,0,Blocks.planks,0);
		bb.buildBlock(0,4,1,Blocks.planks,0);bb.buildBlock(0,4,2,Blocks.planks,1);bb.buildBlock(0,4,3,Blocks.spruce_stairs,3);
		bb.buildBlock(1,4,-3,Blocks.spruce_stairs,2);bb.buildBlock(1,4,-2,Blocks.planks,1);bb.buildBlock(1,4,-1,Blocks.planks,0);
		bb.buildBlock(1,4,0,Blocks.planks,0);bb.buildBlock(1,4,1,Blocks.planks,0);bb.buildBlock(1,4,2,Blocks.planks,1);
		bb.buildBlock(1,4,3,Blocks.spruce_stairs,3);bb.buildBlock(2,4,-3,Blocks.spruce_stairs,2);bb.buildBlock(2,4,-2,Blocks.planks,1);
		bb.buildBlock(2,4,-1,Blocks.planks,1);bb.buildBlock(2,4,0,Blocks.planks,1);bb.buildBlock(2,4,1,Blocks.planks,1);
		bb.buildBlock(2,4,2,Blocks.planks,1);bb.buildBlock(2,4,3,Blocks.spruce_stairs,3);bb.buildBlock(3,4,-2,Blocks.spruce_stairs,1);
		bb.buildBlock(3,4,-1,Blocks.spruce_stairs,1);bb.buildBlock(3,4,0,Blocks.spruce_stairs,1);bb.buildBlock(3,4,1,Blocks.spruce_stairs,1);
