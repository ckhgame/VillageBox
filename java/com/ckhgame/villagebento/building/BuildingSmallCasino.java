...
public class BuildingSmallCasino extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-2,0,2,Blocks.chest,2);bb.buildBlock(-2,0,3,Blocks.sandstone,2);bb.buildBlock(-1,0,-3,Blocks.sandstone,2);
		bb.buildBlock(-1,0,-1,Blocks.planks,2);bb.buildBlock(-1,0,0,Blocks.planks,2);bb.buildBlock(-1,0,1,Blocks.planks,2);
		bb.buildBlock(-1,0,2,Blocks.planks,2);bb.buildBlock(-1,0,3,Blocks.sandstone,2);bb.buildBlock(0,0,-3,Blocks.sandstone,2);
		bb.buildBlock(0,0,3,Blocks.sandstone,2);bb.buildBlock(1,0,-3,Blocks.sandstone,2);bb.buildBlock(1,0,-1,Blocks.dark_oak_stairs,2);
		bb.buildBlock(1,0,1,Blocks.dark_oak_stairs,3);bb.buildBlock(1,0,3,Blocks.sandstone,2);bb.buildBlock(2,0,-3,Blocks.sandstone,2);
		bb.buildBlock(2,0,-1,Blocks.dark_oak_stairs,2);bb.buildBlock(2,0,1,Blocks.dark_oak_stairs,3);bb.buildBlock(2,0,3,Blocks.sandstone,2);
		bb.buildBlock(3,0,-3,Blocks.sandstone,2);bb.buildBlock(3,0,-2,Blocks.sandstone,2);bb.buildBlock(3,0,-1,Blocks.sandstone,2);
		bb.buildBlock(3,0,0,Blocks.wooden_door,0);bb.buildBlock(3,0,1,Blocks.sandstone,2);bb.buildBlock(3,0,2,Blocks.sandstone,2);
		bb.buildBlock(3,0,3,Blocks.sandstone,2);bb.buildBlock(-3,1,-3,Blocks.sandstone,2);bb.buildBlock(-3,1,-2,Blocks.glass_pane,0);
		bb.buildBlock(-3,1,-1,Blocks.sandstone,2);bb.buildBlock(-3,1,0,Blocks.glass_pane,0);bb.buildBlock(-3,1,1,Blocks.sandstone,2);
		bb.buildBlock(-3,1,2,Blocks.glass_pane,0);bb.buildBlock(-3,1,3,Blocks.sandstone,2);bb.buildBlock(-2,1,-3,Blocks.glass_pane,0);
		bb.buildBlock(-2,1,3,Blocks.glass_pane,0);bb.buildBlock(-1,1,-3,Blocks.sandstone,2);bb.buildBlock(-1,1,-1,Blocks.double_wooden_slab,2);
		bb.buildBlock(-1,1,0,Blocks.wooden_slab,10);bb.buildBlock(-1,1,1,Blocks.double_wooden_slab,2);bb.buildBlock(-1,1,2,Blocks.wooden_slab,10);
		bb.buildBlock(-1,1,3,Blocks.sandstone,2);bb.buildBlock(0,1,-3,Blocks.glass_pane,0);bb.buildBlock(0,1,3,Blocks.glass_pane,0);
		bb.buildBlock(1,1,-3,Blocks.sandstone,2);bb.buildBlock(1,1,3,Blocks.sandstone,2);bb.buildBlock(2,1,-3,Blocks.glass_pane,0);
		bb.buildBlock(2,1,3,Blocks.glass_pane,0);bb.buildBlock(3,1,-3,Blocks.sandstone,2);bb.buildBlock(3,1,-2,Blocks.glass_pane,0);
		bb.buildBlock(3,1,-1,Blocks.sandstone,2);bb.buildBlock(3,1,0,Blocks.wooden_door,8);bb.buildBlock(3,1,1,Blocks.sandstone,2);
		bb.buildBlock(3,1,2,Blocks.glass_pane,0);bb.buildBlock(3,1,3,Blocks.sandstone,2);bb.buildBlock(-3,2,-3,Blocks.sandstone,2);
		bb.buildBlock(-3,2,-2,Blocks.glass_pane,0);bb.buildBlock(-3,2,-1,Blocks.sandstone,2);bb.buildBlock(-3,2,0,Blocks.glass_pane,0);
		bb.buildBlock(-3,2,1,Blocks.sandstone,2);bb.buildBlock(-3,2,2,Blocks.glass_pane,0);bb.buildBlock(-3,2,3,Blocks.sandstone,2);
		bb.buildBlock(-2,2,-3,Blocks.glass_pane,0);bb.buildBlock(-2,2,3,Blocks.glass_pane,0);bb.buildBlock(-1,2,-3,Blocks.sandstone,2);
		bb.buildBlock(-1,2,-1,Blocks.double_wooden_slab,2);bb.buildBlock(-1,2,0,Blocks.flower_pot,0);bb.buildBlock(-1,2,1,Blocks.flower_pot,0);
		bb.buildBlock(-1,2,2,Blocks.flower_pot,0);bb.buildBlock(-1,2,3,Blocks.sandstone,2);bb.buildBlock(0,2,-3,Blocks.glass_pane,0);
		...
		bb.buildBlock(-1,3,-3,Blocks.sandstone,2);bb.buildBlock(-1,3,-1,Blocks.wooden_slab,2);bb.buildBlock(-1,3,0,Blocks.wooden_slab,2);
		bb.buildBlock(-1,3,1,Blocks.wooden_slab,2);bb.buildBlock(-1,3,2,Blocks.wooden_slab,2);bb.buildBlock(-1,3,3,Blocks.sandstone,2);
		bb.buildBlock(0,3,-3,Blocks.sandstone,2);bb.buildBlock(0,3,3,Blocks.sandstone,2);bb.buildBlock(1,3,-3,Blocks.sandstone,2);
		bb.buildBlock(1,3,3,Blocks.sandstone,2);bb.buildBlock(2,3,-3,Blocks.sandstone,2);bb.buildBlock(2,3,3,Blocks.sandstone,2);
		bb.buildBlock(3,3,-3,Blocks.sandstone,2);bb.buildBlock(3,3,-2,Blocks.sandstone,2);bb.buildBlock(3,3,-1,Blocks.sandstone,2);
		bb.buildBlock(3,3,0,Blocks.sandstone,2);bb.buildBlock(3,3,1,Blocks.sandstone,2);bb.buildBlock(3,3,2,Blocks.sandstone,2);
		bb.buildBlock(3,3,3,Blocks.sandstone,2);bb.buildBlock(-3,4,-3,Blocks.wooden_slab,4);bb.buildBlock(-3,4,-2,Blocks.planks,4);
		bb.buildBlock(-3,4,-1,Blocks.wooden_slab,4);bb.buildBlock(-3,4,0,Blocks.planks,4);bb.buildBlock(-3,4,1,Blocks.wooden_slab,4);
		bb.buildBlock(-3,4,2,Blocks.planks,4);bb.buildBlock(-3,4,3,Blocks.wooden_slab,4);bb.buildBlock(-2,4,-3,Blocks.planks,4);
		...
		bb.buildBlock(-1,4,-3,Blocks.wooden_slab,4);bb.buildBlock(-1,4,-2,Blocks.planks,4);bb.buildBlock(-1,4,-1,Blocks.glass,0);
		bb.buildBlock(-1,4,0,Blocks.glass,0);bb.buildBlock(-1,4,1,Blocks.glass,0);bb.buildBlock(-1,4,2,Blocks.planks,4);
		bb.buildBlock(-1,4,3,Blocks.wooden_slab,4);bb.buildBlock(0,4,-3,Blocks.planks,4);bb.buildBlock(0,4,-2,Blocks.planks,4);
		bb.buildBlock(0,4,-1,Blocks.glass,0);bb.buildBlock(0,4,0,Blocks.planks,4);bb.buildBlock(0,4,1,Blocks.glass,0);
		bb.buildBlock(0,4,2,Blocks.planks,4);bb.buildBlock(0,4,3,Blocks.planks,4);bb.buildBlock(1,4,-3,Blocks.wooden_slab,4);
		...
		bb.buildBlock(2,4,3,Blocks.double_wooden_slab,4);bb.buildBlock(3,4,-3,Blocks.wooden_slab,4);bb.buildBlock(3,4,-2,Blocks.planks,4);
		bb.buildBlock(3,4,-1,Blocks.wooden_slab,4);bb.buildBlock(3,4,0,Blocks.planks,4);bb.buildBlock(3,4,1,Blocks.wooden_slab,4);
		bb.buildBlock(3,4,2,Blocks.planks,4);bb.buildBlock(3,4,3,Blocks.wooden_slab,4);bb.buildBlock(-2,5,-1,Blocks.wooden_slab,4);
		bb.buildBlock(-2,5,1,Blocks.wooden_slab,4);bb.buildBlock(-1,5,-2,Blocks.wooden_slab,4);bb.buildBlock(-1,5,2,Blocks.wooden_slab,4);
		bb.buildBlock(1,5,-2,Blocks.wooden_slab,4);bb.buildBlock(1,5,2,Blocks.wooden_slab,4);bb.buildBlock(2,5,-1,Blocks.wooden_slab,4);
		bb.buildBlock(2,5,1,Blocks.wooden_slab,4);bb.buildBlock(-2,2,-1,Blocks.torch,1);bb.buildBlock(-2,2,1,Blocks.torch,1);
		bb.buildBlock(2,2,-1,Blocks.torch,2);bb.buildBlock(2,2,1,Blocks.torch,2);bb.buildBlock(-2,3,-2,Blocks.torch,3);
		bb.buildBlock(0,3,-2,Blocks.torch,3);bb.buildBlock(0,3,2,Blocks.torch,4);bb.buildBlock(2,3,-2,Blocks.torch,3);
		bb.buildBlock(2,3,2,Blocks.torch,4);
