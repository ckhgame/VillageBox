...
public class BuildingLargeMilitaryCamp extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-4,0,-3,Blocks.dark_oak_stairs,1);bb.buildBlock(-4,0,0,Blocks.dark_oak_stairs,1);bb.buildBlock(-4,0,1,Blocks.dark_oak_stairs,1);
		...
		bb.buildBlock(-1,0,1,Blocks.trapped_chest,4);bb.buildBlock(-1,0,5,Blocks.stonebrick,0);bb.buildBlock(0,0,-5,Blocks.stonebrick,0);
		bb.buildBlock(0,0,0,Blocks.stonebrick,0);bb.buildBlock(0,0,1,Blocks.stonebrick,0);bb.buildBlock(0,0,5,Blocks.stonebrick,0);
		bb.buildBlock(1,0,-5,Blocks.stonebrick,0);bb.buildBlock(1,0,0,Blocks.stone_brick_stairs,1);bb.buildBlock(1,0,1,Blocks.stone_brick_stairs,1);
		...
		bb.buildBlock(5,0,-2,Blocks.stonebrick,0);bb.buildBlock(5,0,-1,Blocks.stonebrick,0);bb.buildBlock(5,0,0,Blocks.wooden_door,4);
		bb.buildBlock(5,0,1,Blocks.wooden_door,4);bb.buildBlock(5,0,2,Blocks.stonebrick,0);bb.buildBlock(5,0,3,Blocks.stonebrick,0);
		...
		bb.buildBlock(-4,2,-5,Blocks.stonebrick,0);bb.buildBlock(-4,2,-4,Blocks.wooden_slab,13);bb.buildBlock(-4,2,-3,Blocks.wooden_slab,13);
		bb.buildBlock(-4,2,-2,Blocks.wooden_slab,13);bb.buildBlock(-4,2,-1,Blocks.wooden_slab,13);bb.buildBlock(-4,2,0,Blocks.wooden_slab,13);
		bb.buildBlock(-4,2,1,Blocks.wooden_slab,13);bb.buildBlock(-4,2,2,Blocks.wooden_slab,13);bb.buildBlock(-4,2,3,Blocks.wooden_slab,13);
		bb.buildBlock(-4,2,4,Blocks.wooden_slab,13);bb.buildBlock(-4,2,5,Blocks.stonebrick,0);bb.buildBlock(-3,2,-5,Blocks.stonebrick,0);
		bb.buildBlock(-3,2,-4,Blocks.wooden_slab,13);bb.buildBlock(-3,2,-3,Blocks.wooden_slab,13);bb.buildBlock(-3,2,-2,Blocks.wooden_slab,13);
		bb.buildBlock(-3,2,3,Blocks.wooden_slab,13);bb.buildBlock(-3,2,4,Blocks.wooden_slab,13);bb.buildBlock(-3,2,5,Blocks.stonebrick,0);
		bb.buildBlock(-2,2,-5,Blocks.stonebrick,0);bb.buildBlock(-2,2,-4,Blocks.wooden_slab,13);bb.buildBlock(-2,2,-3,Blocks.wooden_slab,13);
		bb.buildBlock(-2,2,-2,Blocks.wooden_slab,13);bb.buildBlock(-2,2,3,Blocks.wooden_slab,13);bb.buildBlock(-2,2,4,Blocks.wooden_slab,13);
		bb.buildBlock(-2,2,5,Blocks.stonebrick,0);bb.buildBlock(-1,2,-5,Blocks.stonebrick,0);bb.buildBlock(-1,2,-4,Blocks.wooden_slab,13);
		bb.buildBlock(-1,2,-3,Blocks.wooden_slab,13);bb.buildBlock(-1,2,-2,Blocks.wooden_slab,13);bb.buildBlock(-1,2,0,Blocks.stone_brick_stairs,1);
		bb.buildBlock(-1,2,1,Blocks.stone_brick_stairs,1);bb.buildBlock(-1,2,3,Blocks.wooden_slab,13);bb.buildBlock(-1,2,4,Blocks.wooden_slab,13);
		bb.buildBlock(-1,2,5,Blocks.stonebrick,0);bb.buildBlock(0,2,-5,Blocks.stonebrick,0);bb.buildBlock(0,2,-4,Blocks.wooden_slab,13);
		bb.buildBlock(0,2,-3,Blocks.wooden_slab,13);bb.buildBlock(0,2,-2,Blocks.wooden_slab,13);bb.buildBlock(0,2,3,Blocks.wooden_slab,13);
		bb.buildBlock(0,2,4,Blocks.wooden_slab,13);bb.buildBlock(0,2,5,Blocks.stonebrick,0);bb.buildBlock(1,2,-5,Blocks.stonebrick,0);
		bb.buildBlock(1,2,-4,Blocks.dark_oak_stairs,1);bb.buildBlock(1,2,-3,Blocks.dark_oak_stairs,1);bb.buildBlock(1,2,-2,Blocks.dark_oak_stairs,1);
		bb.buildBlock(1,2,3,Blocks.double_wooden_slab,5);bb.buildBlock(1,2,4,Blocks.double_wooden_slab,5);bb.buildBlock(1,2,5,Blocks.stonebrick,0);
		bb.buildBlock(2,2,-5,Blocks.stonebrick,0);bb.buildBlock(2,2,5,Blocks.stonebrick,0);bb.buildBlock(3,2,-5,Blocks.glass_pane,0);
		bb.buildBlock(3,2,5,Blocks.glass_pane,0);bb.buildBlock(4,2,-5,Blocks.stonebrick,0);bb.buildBlock(4,2,5,Blocks.stonebrick,0);
		...
		bb.buildBlock(5,2,4,Blocks.stonebrick,0);bb.buildBlock(5,2,5,Blocks.stonebrick,0);bb.buildBlock(-5,3,-5,Blocks.stonebrick,0);
		bb.buildBlock(-5,3,-4,Blocks.stonebrick,0);bb.buildBlock(-5,3,-3,Blocks.stonebrick,0);bb.buildBlock(-5,3,-2,Blocks.stonebrick,0);
		bb.buildBlock(-5,3,-1,Blocks.stonebrick,0);bb.buildBlock(-5,3,0,Blocks.glass_pane,0);bb.buildBlock(-5,3,1,Blocks.glass_pane,0);
		bb.buildBlock(-5,3,2,Blocks.glass_pane,0);bb.buildBlock(-5,3,3,Blocks.stonebrick,0);bb.buildBlock(-5,3,4,Blocks.stonebrick,0);
		bb.buildBlock(-5,3,5,Blocks.stonebrick,0);bb.buildBlock(-4,3,-5,Blocks.stonebrick,0);bb.buildBlock(-4,3,-4,Blocks.chest,5);
		bb.buildBlock(-4,3,-3,Blocks.chest,5);bb.buildBlock(-4,3,3,Blocks.chest,5);bb.buildBlock(-4,3,4,Blocks.chest,5);
		bb.buildBlock(-4,3,5,Blocks.stonebrick,0);bb.buildBlock(-3,3,-5,Blocks.stonebrick,0);bb.buildBlock(-3,3,5,Blocks.stonebrick,0);
		...
		bb.buildBlock(4,7,2,Blocks.stonebrick,0);bb.buildBlock(4,7,3,Blocks.stonebrick,0);bb.buildBlock(4,7,4,Blocks.stonebrick,0);
		...
		bb.buildBlock(4,9,3,Blocks.dark_oak_stairs,1);bb.buildBlock(4,9,4,Blocks.dark_oak_stairs,3);bb.buildBlock(-4,1,-1,Blocks.torch,1);
		bb.buildBlock(-4,1,2,Blocks.torch,1);bb.buildBlock(-1,1,0,Blocks.torch,2);bb.buildBlock(-1,1,1,Blocks.torch,2);
		bb.buildBlock(4,2,-1,Blocks.torch,2);bb.buildBlock(4,2,2,Blocks.torch,2);bb.buildBlock(4,4,-4,Blocks.torch,2);
		bb.buildBlock(4,4,4,Blocks.torch,2);bb.buildBlock(-3,8,-3,Blocks.torch,3);bb.buildBlock(-3,8,0,Blocks.torch,1);
		bb.buildBlock(-3,8,1,Blocks.torch,1);bb.buildBlock(-3,8,3,Blocks.torch,4);bb.buildBlock(-1,8,-3,Blocks.torch,3);
		bb.buildBlock(-1,8,3,Blocks.torch,4);bb.buildBlock(1,8,-3,Blocks.torch,3);bb.buildBlock(1,8,3,Blocks.torch,4);
	}
