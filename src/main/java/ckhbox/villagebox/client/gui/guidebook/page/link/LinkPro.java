...
public class LinkPro extends Link{
	...
	public void onDraw(int mouseX, int mouseY){
		...
		this.page.guiGuideBook.drawProHead(this.left, this.top, pro, false);
		this.page.guiGuideBook.drawProHead(this.left + 8, this.top + 2, pro, true);
	...
	public void onDrawHover(int mouseX, int mouseY){
		...
		this.page.guiGuideBook.drawProHead(this.left, this.top + 2, pro, false);
		this.page.guiGuideBook.drawProHead(this.left + 8, this.top, pro, true);
		GlStateManager.enableLighting();
	}
}
