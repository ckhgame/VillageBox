...
public class GuiMail extends GuiContainer{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.buttonApprove = new GuiTextButton(this.mc, 0, 0,y + 130, I18n.translateToLocal(PathHelper.full("gui.mail.button.approve"))));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ItemStack hold = this.player.getHeldItemMainhand();
        if(hold.getItem() == ModItems.mail){
        	String content = I18n.translateToLocal(ItemMail.getMailContent(hold));
        	String sender = I18n.translateToLocalFormatted(PathHelper.full("gui.mail.from"), ItemMail.getMailSender(hold));
        	String hi = I18n.translateToLocalFormatted(PathHelper.full("gui.mail.hi"), this.player.getName(),false);
