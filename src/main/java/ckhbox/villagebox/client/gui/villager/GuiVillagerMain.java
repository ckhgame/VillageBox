...
public class GuiVillagerMain extends GuiContainer{
    ...
    private void refreshChatContent(){
    	...
    	for(int i =0;i<2;i++){
    		list.add(StatCollector.translateToLocal(PathHelper.full("gui.villagermain.menu.chat."+ home + i)));
    	}
    ...
    private void setChatContent(String type){
    	this.chatContent = StatCollector.translateToLocal(PathHelper.full("gui.villagermain.menu.chat." + type));
    	this.chatContentDisplay = "";
