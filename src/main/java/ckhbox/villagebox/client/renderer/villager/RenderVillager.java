...
public class RenderVillager extends RenderBiped<EntityVillager>{
	...
	private void renderQuestMark(double x, double y, double z, float rotY){
        ...
        renderColorBox(this.questMarkBoundTop,x,y,z,rotY,1.0F,1.0F,0.0F);
        renderColorBox(this.questMarkBoundBot,x,y,z,rotY,1.0F,1.0F,0.0F);      
	}
	
	private void renderColorBox(AxisAlignedBB boundingBox, double x, double y, double z,float rotY, float r, float g, float b){
