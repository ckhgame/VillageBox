...
public class RenderFishVB extends Render
{
     ...
     */
    public void doRender(EntityFishHookVB p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
     ...
     */
    protected ResourceLocation getEntityTexture(EntityFishHookVB p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityFishHookVB)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityFishHookVB)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}