...
public class BuildingFolkHouse extends Building {
	...
	private void buildBlocks_style3(BuildingBuilder bb){
		...
		bb.buildBlock(0,0,2,Blocks.planks,1);bb.buildBlock(1,0,-3,Blocks.planks,1);bb.buildBlock(1,0,-2,Blocks.bed,10);
		bb.buildBlock(1,0,-1,Blocks.bed,2);bb.buildBlock(1,0,2,Blocks.planks,1);bb.buildBlock(2,0,-3,Blocks.planks,1);
		bb.buildBlock(2,0,-2,Blocks.planks,1);bb.buildBlock(2,0,-1,Blocks.planks,1);bb.buildBlock(2,0,0,Blocks.planks,1);
		bb.buildBlock(2,0,1,Blocks.wooden_door,2);bb.buildBlock(2,0,2,Blocks.planks,1);bb.buildBlock(3,0,-2,Blocks.jungle_stairs,1);
		bb.buildBlock(3,0,-1,Blocks.jungle_stairs,1);bb.buildBlock(3,0,3,Blocks.fence,0);bb.buildBlock(-3,1,3,Blocks.acacia_stairs,3);
		bb.buildBlock(-2,1,-3,Blocks.planks,1);bb.buildBlock(-2,1,-2,Blocks.planks,1);bb.buildBlock(-2,1,-1,Blocks.glass_pane,0);
		bb.buildBlock(-2,1,0,Blocks.glass_pane,0);bb.buildBlock(-2,1,1,Blocks.glass_pane,0);bb.buildBlock(-2,1,2,Blocks.planks,1);
		bb.buildBlock(-2,1,3,Blocks.acacia_stairs,3);bb.buildBlock(-1,1,-3,Blocks.planks,1);bb.buildBlock(-1,1,-2,Blocks.flower_pot,7);
		bb.addTileEntityPot(-1,1,-2,38,7);
		...
		bb.buildBlock(2,1,1,Blocks.wooden_door,8);bb.buildBlock(2,1,2,Blocks.planks,1);bb.buildBlock(2,1,3,Blocks.acacia_stairs,3);
		bb.buildBlock(3,1,3,Blocks.acacia_stairs,3);bb.buildBlock(-3,2,-3,Blocks.wooden_slab,4);bb.buildBlock(-3,2,-2,Blocks.double_wooden_slab,4);
		bb.buildBlock(-3,2,-1,Blocks.wooden_slab,12);bb.buildBlock(-3,2,2,Blocks.acacia_stairs,3);bb.buildBlock(-2,2,-3,Blocks.wooden_slab,4);
		bb.buildBlock(-2,2,-2,Blocks.planks,4);bb.buildBlock(-2,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(-2,2,0,Blocks.planks,1);
		bb.buildBlock(-2,2,1,Blocks.planks,1);bb.buildBlock(-2,2,2,Blocks.acacia_stairs,3);bb.buildBlock(-1,2,-3,Blocks.wooden_slab,4);
		...
		bb.buildBlock(0,2,-3,Blocks.wooden_slab,4);bb.buildBlock(0,2,-2,Blocks.planks,4);bb.buildBlock(0,2,-1,Blocks.double_wooden_slab,4);
		bb.buildBlock(0,2,2,Blocks.acacia_stairs,3);bb.buildBlock(1,2,-3,Blocks.wooden_slab,4);bb.buildBlock(1,2,-2,Blocks.planks,4);
		bb.buildBlock(1,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(1,2,2,Blocks.acacia_stairs,3);bb.buildBlock(2,2,-3,Blocks.wooden_slab,4);
		bb.buildBlock(2,2,-2,Blocks.planks,4);bb.buildBlock(2,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(2,2,0,Blocks.planks,4);
		bb.buildBlock(2,2,1,Blocks.planks,4);bb.buildBlock(2,2,2,Blocks.acacia_stairs,3);bb.buildBlock(3,2,-3,Blocks.wooden_slab,4);
		...
		bb.buildBlock(-3,3,-1,Blocks.wooden_slab,4);bb.buildBlock(-3,3,0,Blocks.planks,4);bb.buildBlock(-3,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(-2,3,-1,Blocks.wooden_slab,4);bb.buildBlock(-2,3,0,Blocks.planks,4);bb.buildBlock(-2,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(-1,3,-1,Blocks.wooden_slab,4);bb.buildBlock(-1,3,0,Blocks.planks,4);bb.buildBlock(-1,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(0,3,-1,Blocks.wooden_slab,4);bb.buildBlock(0,3,0,Blocks.planks,4);bb.buildBlock(0,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(1,3,-1,Blocks.wooden_slab,4);bb.buildBlock(1,3,0,Blocks.planks,4);bb.buildBlock(1,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(2,3,-1,Blocks.wooden_slab,4);bb.buildBlock(2,3,0,Blocks.planks,4);bb.buildBlock(2,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(3,3,-1,Blocks.wooden_slab,4);bb.buildBlock(3,3,0,Blocks.planks,4);bb.buildBlock(3,3,1,Blocks.acacia_stairs,3);
		bb.buildBlock(-1,2,0,Blocks.torch,1);bb.buildBlock(-1,2,1,Blocks.torch,1);bb.buildBlock(1,2,1,Blocks.torch,2);
		bb.addEntityPainting(0,2,2,2,"Pool");
	}
	...
	private void buildBlocks_style4(BuildingBuilder bb){
		...
		bb.buildBlock(-3,2,0,Blocks.planks,4);bb.buildBlock(-3,2,1,Blocks.planks,4);bb.buildBlock(-3,2,2,Blocks.planks,4);
		bb.buildBlock(-3,2,3,Blocks.acacia_stairs,3);bb.buildBlock(-2,2,-3,Blocks.acacia_stairs,2);bb.buildBlock(-2,2,-2,Blocks.planks,4);
		bb.buildBlock(-2,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(-2,2,0,Blocks.planks,4);bb.buildBlock(-2,2,1,Blocks.glass,0);
		bb.buildBlock(-2,2,2,Blocks.planks,4);bb.buildBlock(-2,2,3,Blocks.acacia_stairs,3);bb.buildBlock(-1,2,-3,Blocks.acacia_stairs,2);
		bb.buildBlock(-1,2,-2,Blocks.planks,4);bb.buildBlock(-1,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(-1,2,0,Blocks.planks,4);
		bb.buildBlock(-1,2,1,Blocks.glass,0);bb.buildBlock(-1,2,2,Blocks.planks,4);bb.buildBlock(-1,2,3,Blocks.acacia_stairs,3);
		bb.buildBlock(0,2,-3,Blocks.acacia_stairs,2);bb.buildBlock(0,2,-2,Blocks.planks,4);bb.buildBlock(0,2,-1,Blocks.double_wooden_slab,4);
		bb.buildBlock(0,2,0,Blocks.planks,4);bb.buildBlock(0,2,1,Blocks.glass,0);bb.buildBlock(0,2,2,Blocks.planks,4);
		bb.buildBlock(0,2,3,Blocks.acacia_stairs,3);bb.buildBlock(1,2,-3,Blocks.acacia_stairs,2);bb.buildBlock(1,2,-2,Blocks.planks,4);
		bb.buildBlock(1,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(1,2,0,Blocks.planks,4);bb.buildBlock(1,2,1,Blocks.planks,4);
		bb.buildBlock(1,2,2,Blocks.planks,4);bb.buildBlock(1,2,3,Blocks.acacia_stairs,3);bb.buildBlock(2,2,-3,Blocks.acacia_stairs,2);
		bb.buildBlock(2,2,-2,Blocks.planks,4);bb.buildBlock(2,2,-1,Blocks.double_wooden_slab,4);bb.buildBlock(2,2,0,Blocks.planks,4);
		bb.buildBlock(2,2,1,Blocks.planks,4);bb.buildBlock(2,2,2,Blocks.planks,4);bb.buildBlock(2,2,3,Blocks.acacia_stairs,3);
		bb.buildBlock(3,2,-2,Blocks.acacia_stairs,1);bb.buildBlock(3,2,-1,Blocks.acacia_stairs,1);bb.buildBlock(3,2,0,Blocks.acacia_stairs,1);
		bb.buildBlock(3,2,1,Blocks.acacia_stairs,1);bb.buildBlock(3,2,2,Blocks.acacia_stairs,1);bb.buildBlock(-3,3,-2,Blocks.fence,0);
		bb.buildBlock(-3,3,-1,Blocks.fence,0);bb.buildBlock(-3,3,0,Blocks.fence,0);bb.buildBlock(-3,3,1,Blocks.fence,0);
		bb.buildBlock(-3,3,2,Blocks.fence,0);bb.buildBlock(-2,3,-2,Blocks.fence,0);bb.buildBlock(-2,3,2,Blocks.fence,0);
		bb.buildBlock(-1,3,-2,Blocks.fence,0);bb.buildBlock(-1,3,2,Blocks.fence,0);bb.buildBlock(0,3,-2,Blocks.fence,0);
		bb.buildBlock(0,3,2,Blocks.fence,0);bb.buildBlock(1,3,-2,Blocks.fence,0);bb.buildBlock(1,3,2,Blocks.fence,0);
		bb.buildBlock(2,3,-2,Blocks.fence,0);bb.buildBlock(2,3,-1,Blocks.fence,0);bb.buildBlock(2,3,0,Blocks.fence,0);
		bb.buildBlock(2,3,1,Blocks.fence,0);bb.buildBlock(2,3,2,Blocks.fence,0);
	}
