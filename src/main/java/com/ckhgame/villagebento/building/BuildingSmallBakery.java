...
public class BuildingSmallBakery extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(1,0,2,ModBlocks.blockOakChair,0);bb.buildBlock(1,0,3,Blocks.planks,0);bb.buildBlock(1,0,4,Blocks.planks,1);bb.buildBlock(2,0,-4,Blocks.planks,1);
		bb.buildBlock(2,0,-3,Blocks.carpet,14);bb.buildBlock(2,0,-2,Blocks.carpet,14);bb.buildBlock(2,0,-1,Blocks.carpet,14);
		bb.buildBlock(2,0,2,ModBlocks.blockOakChair,0);bb.buildBlock(2,0,3,Blocks.planks,0);bb.buildBlock(2,0,4,Blocks.planks,1);bb.buildBlock(3,0,-4,Blocks.planks,1);
		bb.buildBlock(3,0,-3,Blocks.carpet,14);bb.buildBlock(3,0,-2,Blocks.carpet,14);bb.buildBlock(3,0,-1,Blocks.carpet,14);
		bb.buildBlock(3,0,2,ModBlocks.blockOakChair,0);bb.buildBlock(3,0,3,Blocks.planks,0);bb.buildBlock(3,0,4,Blocks.planks,1);bb.buildBlock(4,0,-4,Blocks.planks,1);
