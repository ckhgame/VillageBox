...
public class BuildingBlacksmithsShop extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(-3,3,-4,Blocks.acacia_stairs,2);bb.buildBlock(-3,3,-3,Blocks.planks,1);bb.buildBlock(-3,3,-1,Blocks.planks,1);
		bb.buildBlock(-3,3,0,Blocks.planks,1);bb.buildBlock(-3,3,1,Blocks.planks,1);bb.buildBlock(-3,3,2,Blocks.stonebrick,0);
		bb.buildBlock(-3,3,3,Blocks.stonebrick,0);bb.buildBlock(-3,3,4,Blocks.acacia_stairs,3);bb.buildBlock(-2,3,-4,Blocks.acacia_stairs,2);
		bb.buildBlock(-2,3,-3,Blocks.planks,1);bb.buildBlock(-2,3,-1,Blocks.planks,1);bb.buildBlock(-2,3,0,Blocks.planks,1);
		bb.buildBlock(-2,3,1,Blocks.planks,1);bb.buildBlock(-2,3,2,Blocks.stonebrick,0);bb.buildBlock(-2,3,3,Blocks.stonebrick,0);
		bb.buildBlock(-2,3,4,Blocks.acacia_stairs,3);bb.buildBlock(-1,3,-4,Blocks.acacia_stairs,2);bb.buildBlock(-1,3,-3,Blocks.planks,1);
		bb.buildBlock(-1,3,-1,Blocks.planks,1);bb.buildBlock(-1,3,0,Blocks.planks,1);bb.buildBlock(-1,3,3,Blocks.planks,1);
		bb.buildBlock(-1,3,4,Blocks.acacia_stairs,3);bb.buildBlock(0,3,-4,Blocks.acacia_stairs,2);bb.buildBlock(0,3,-3,Blocks.planks,1);
		bb.buildBlock(0,3,-2,Blocks.planks,1);bb.buildBlock(0,3,-1,Blocks.planks,1);bb.buildBlock(0,3,0,Blocks.planks,1);
		bb.buildBlock(0,3,3,Blocks.planks,1);bb.buildBlock(0,3,4,Blocks.acacia_stairs,3);bb.buildBlock(1,3,-4,Blocks.acacia_stairs,2);
		bb.buildBlock(1,3,-3,Blocks.planks,1);bb.buildBlock(1,3,0,Blocks.planks,1);bb.buildBlock(1,3,3,Blocks.planks,1);
		bb.buildBlock(1,3,4,Blocks.acacia_stairs,3);bb.buildBlock(2,3,-4,Blocks.acacia_stairs,2);bb.buildBlock(2,3,-3,Blocks.planks,1);
		bb.buildBlock(2,3,0,Blocks.planks,1);bb.buildBlock(2,3,3,Blocks.planks,1);bb.buildBlock(2,3,4,Blocks.acacia_stairs,3);
		bb.buildBlock(3,3,-4,Blocks.acacia_stairs,2);bb.buildBlock(3,3,-3,Blocks.planks,1);bb.buildBlock(3,3,0,Blocks.planks,1);
		bb.buildBlock(3,3,3,Blocks.planks,1);bb.buildBlock(3,3,4,Blocks.acacia_stairs,3);bb.buildBlock(4,3,-4,Blocks.acacia_stairs,2);
		...
		bb.buildBlock(5,3,-3,Blocks.acacia_stairs,7);bb.buildBlock(5,3,3,Blocks.acacia_stairs,6);bb.buildBlock(5,3,4,Blocks.acacia_stairs,3);
		bb.buildBlock(-5,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(-5,4,-2,Blocks.wooden_slab,12);bb.buildBlock(-5,4,-1,Blocks.wooden_slab,12);
		bb.buildBlock(-5,4,0,Blocks.wooden_slab,12);bb.buildBlock(-5,4,1,Blocks.wooden_slab,12);bb.buildBlock(-5,4,2,Blocks.wooden_slab,12);
		bb.buildBlock(-5,4,3,Blocks.acacia_stairs,3);bb.buildBlock(-4,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(-4,4,-2,Blocks.planks,4);
		...
		bb.buildBlock(-3,4,-2,Blocks.planks,1);bb.buildBlock(-3,4,-1,Blocks.planks,4);bb.buildBlock(-3,4,0,Blocks.planks,4);
		bb.buildBlock(-3,4,1,Blocks.planks,4);bb.buildBlock(-3,4,2,Blocks.stonebrick,0);bb.buildBlock(-3,4,3,Blocks.stonebrick,0);
		bb.buildBlock(-2,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(-2,4,-2,Blocks.planks,1);bb.buildBlock(-2,4,-1,Blocks.planks,4);
		bb.buildBlock(-2,4,0,Blocks.planks,4);bb.buildBlock(-2,4,1,Blocks.planks,4);bb.buildBlock(-2,4,2,Blocks.stonebrick,0);
		bb.buildBlock(-2,4,3,Blocks.stonebrick,0);bb.buildBlock(-1,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(-1,4,-2,Blocks.planks,1);
		bb.buildBlock(-1,4,-1,Blocks.planks,4);bb.buildBlock(-1,4,0,Blocks.planks,4);bb.buildBlock(-1,4,1,Blocks.planks,4);
		bb.buildBlock(-1,4,2,Blocks.planks,1);bb.buildBlock(-1,4,3,Blocks.acacia_stairs,3);bb.buildBlock(0,4,-3,Blocks.acacia_stairs,2);
		bb.buildBlock(0,4,-2,Blocks.planks,1);bb.buildBlock(0,4,-1,Blocks.planks,4);bb.buildBlock(0,4,0,Blocks.planks,4);
		bb.buildBlock(0,4,1,Blocks.planks,4);bb.buildBlock(0,4,2,Blocks.planks,1);bb.buildBlock(0,4,3,Blocks.acacia_stairs,3);
		bb.buildBlock(1,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(1,4,-2,Blocks.planks,1);bb.buildBlock(1,4,-1,Blocks.planks,4);
		bb.buildBlock(1,4,0,Blocks.planks,4);bb.buildBlock(1,4,1,Blocks.planks,4);bb.buildBlock(1,4,2,Blocks.planks,1);
		bb.buildBlock(1,4,3,Blocks.acacia_stairs,3);bb.buildBlock(2,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(2,4,-2,Blocks.planks,1);
		bb.buildBlock(2,4,-1,Blocks.planks,4);bb.buildBlock(2,4,0,Blocks.planks,4);bb.buildBlock(2,4,1,Blocks.planks,4);
		bb.buildBlock(2,4,2,Blocks.planks,1);bb.buildBlock(2,4,3,Blocks.acacia_stairs,3);bb.buildBlock(3,4,-3,Blocks.acacia_stairs,2);
		bb.buildBlock(3,4,-2,Blocks.planks,1);bb.buildBlock(3,4,-1,Blocks.planks,4);bb.buildBlock(3,4,0,Blocks.planks,4);
		bb.buildBlock(3,4,1,Blocks.planks,4);bb.buildBlock(3,4,2,Blocks.planks,1);bb.buildBlock(3,4,3,Blocks.acacia_stairs,3);
		bb.buildBlock(4,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(4,4,-2,Blocks.planks,1);bb.buildBlock(4,4,-1,Blocks.planks,4);
		bb.buildBlock(4,4,0,Blocks.planks,4);bb.buildBlock(4,4,1,Blocks.planks,4);bb.buildBlock(4,4,2,Blocks.planks,1);
		bb.buildBlock(4,4,3,Blocks.acacia_stairs,3);bb.buildBlock(5,4,-3,Blocks.acacia_stairs,2);bb.buildBlock(5,4,-2,Blocks.wooden_slab,12);
		bb.buildBlock(5,4,-1,Blocks.wooden_slab,12);bb.buildBlock(5,4,0,Blocks.wooden_slab,12);bb.buildBlock(5,4,1,Blocks.wooden_slab,12);
		bb.buildBlock(5,4,2,Blocks.wooden_slab,12);bb.buildBlock(5,4,3,Blocks.acacia_stairs,3);bb.buildBlock(-3,5,2,Blocks.stonebrick,0);
		bb.buildBlock(-3,5,3,Blocks.stonebrick,0);bb.buildBlock(-2,5,2,Blocks.stonebrick,0);bb.buildBlock(-2,5,3,Blocks.stonebrick,0);
		bb.buildBlock(-3,6,2,Blocks.stonebrick,0);bb.buildBlock(-3,6,3,Blocks.stonebrick,0);bb.buildBlock(-2,6,2,Blocks.stonebrick,0);
		bb.buildBlock(-2,6,3,Blocks.stonebrick,0);bb.buildBlock(-3,7,2,Blocks.stonebrick,0);bb.buildBlock(-3,7,3,Blocks.stonebrick,0);
