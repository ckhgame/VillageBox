...
public class BuildingFarmland extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(0,-1,-7,Blocks.grass,0);bb.buildBlock(0,-1,-6,Blocks.planks,2);bb.buildBlock(0,-1,-5,Blocks.planks,2);
		...
		bb.buildBlock(6,-1,2,Blocks.grass,0);bb.buildBlock(6,-1,3,Blocks.grass,0);bb.buildBlock(6,-1,4,Blocks.grass,0);
		bb.buildBlock(6,-1,5,Blocks.grass,0);bb.buildBlock(6,-1,6,Blocks.grass,0);bb.buildBlock(6,-1,7,Blocks.grass,0);
		bb.buildBlock(7,-1,-7,Blocks.grass,0);bb.buildBlock(7,-1,-6,Blocks.planks,2);bb.buildBlock(7,-1,-5,Blocks.planks,2);
		bb.buildBlock(7,-1,-4,Blocks.planks,2);bb.buildBlock(7,-1,-3,Blocks.planks,2);bb.buildBlock(7,-1,-2,Blocks.planks,2);
		bb.buildBlock(7,-1,-1,Blocks.grass,0);bb.buildBlock(7,-1,0,Blocks.grass,0);bb.buildBlock(7,-1,1,Blocks.grass,0);
		bb.buildBlock(7,-1,2,Blocks.grass,0);bb.buildBlock(7,-1,3,Blocks.grass,0);bb.buildBlock(7,-1,4,Blocks.grass,0);
		bb.buildBlock(7,-1,5,Blocks.grass,0);bb.buildBlock(7,-1,6,Blocks.grass,0);bb.buildBlock(7,-1,7,Blocks.grass,0);
		bb.buildBlock(-6,0,-6,Blocks.planks,1);bb.buildBlock(-6,0,-5,Blocks.planks,1);bb.buildBlock(-6,0,-4,Blocks.planks,1);
		bb.buildBlock(-6,0,-3,Blocks.planks,1);bb.buildBlock(-6,0,-2,Blocks.planks,1);bb.buildBlock(-6,0,-1,Blocks.fence,0);
		bb.buildBlock(-6,0,0,Blocks.fence,0);bb.buildBlock(-6,0,1,Blocks.fence,0);bb.buildBlock(-6,0,2,Blocks.fence,0);
		bb.buildBlock(-6,0,3,Blocks.fence,0);bb.buildBlock(-6,0,4,Blocks.fence,0);bb.buildBlock(-6,0,5,Blocks.fence,0);
		bb.buildBlock(-6,0,6,Blocks.fence,0);bb.buildBlock(-5,0,-6,Blocks.planks,1);bb.buildBlock(-5,0,-4,Blocks.chest,5);
		...
		bb.buildBlock(-5,0,5,Blocks.wheat,7);bb.buildBlock(-5,0,6,Blocks.fence,0);bb.buildBlock(-4,0,-6,Blocks.planks,1);
		bb.buildBlock(-4,0,-5,Blocks.bed,1);bb.buildBlock(-4,0,-4,Blocks.carpet,14);bb.buildBlock(-4,0,-3,Blocks.bed,1);
		bb.buildBlock(-4,0,-2,Blocks.planks,1);bb.buildBlock(-4,0,1,Blocks.fence,0);bb.buildBlock(-4,0,6,Blocks.fence,0);
		bb.buildBlock(-3,0,-6,Blocks.planks,1);bb.buildBlock(-3,0,-5,Blocks.carpet,14);bb.buildBlock(-3,0,-4,Blocks.carpet,14);
		bb.buildBlock(-3,0,-3,Blocks.carpet,14);bb.buildBlock(-3,0,-2,Blocks.wooden_door,3);bb.buildBlock(-3,0,1,Blocks.fence,0);
		bb.buildBlock(-3,0,2,Blocks.wheat,7);bb.buildBlock(-3,0,3,Blocks.wheat,7);bb.buildBlock(-3,0,4,Blocks.wheat,7);
		bb.buildBlock(-3,0,5,Blocks.wheat,7);bb.buildBlock(-3,0,6,Blocks.fence,0);bb.buildBlock(-2,0,-6,Blocks.planks,1);
		...
		bb.buildBlock(-1,0,-6,Blocks.planks,1);bb.buildBlock(-1,0,-5,Blocks.carpet,14);bb.buildBlock(-1,0,-4,Blocks.planks,2);
		bb.buildBlock(-1,0,-3,Blocks.carpet,14);bb.buildBlock(-1,0,-2,Blocks.planks,1);bb.buildBlock(-1,0,1,Blocks.fence,0);
		bb.buildBlock(-1,0,2,Blocks.wheat,7);bb.buildBlock(-1,0,3,Blocks.wheat,7);bb.buildBlock(-1,0,4,Blocks.wheat,7);
		bb.buildBlock(-1,0,5,Blocks.wheat,7);bb.buildBlock(-1,0,6,Blocks.fence,0);bb.buildBlock(0,0,-6,Blocks.planks,1);
		bb.buildBlock(0,0,-5,Blocks.planks,2);bb.buildBlock(0,0,-4,Blocks.planks,2);bb.buildBlock(0,0,-3,Blocks.planks,2);
		bb.buildBlock(0,0,-2,Blocks.planks,1);bb.buildBlock(0,0,1,Blocks.fence,0);bb.buildBlock(0,0,6,Blocks.fence,0);
		...
		bb.buildBlock(1,0,2,Blocks.wheat,7);bb.buildBlock(1,0,3,Blocks.wheat,7);bb.buildBlock(1,0,4,Blocks.wheat,7);
		bb.buildBlock(1,0,5,Blocks.wheat,7);bb.buildBlock(1,0,6,Blocks.fence,0);bb.buildBlock(2,0,-6,Blocks.planks,1);
		bb.buildBlock(2,0,-2,Blocks.planks,1);bb.buildBlock(2,0,1,Blocks.fence,0);bb.buildBlock(2,0,6,Blocks.fence,0);
		bb.buildBlock(3,0,-6,Blocks.planks,1);bb.buildBlock(3,0,-5,Blocks.planks,0);bb.buildBlock(3,0,-4,Blocks.planks,0);
		bb.buildBlock(3,0,-2,Blocks.planks,1);bb.buildBlock(3,0,1,Blocks.fence,0);bb.buildBlock(3,0,2,Blocks.wheat,7);
		bb.buildBlock(3,0,3,Blocks.wheat,7);bb.buildBlock(3,0,4,Blocks.wheat,7);bb.buildBlock(3,0,5,Blocks.wheat,7);
		bb.buildBlock(3,0,6,Blocks.fence,0);bb.buildBlock(4,0,-6,Blocks.planks,1);bb.buildBlock(4,0,-2,Blocks.wooden_door,3);
		bb.buildBlock(4,0,1,Blocks.fence,0);bb.buildBlock(4,0,6,Blocks.fence,0);bb.buildBlock(5,0,-6,Blocks.planks,1);
		...
		bb.buildBlock(5,0,6,Blocks.fence,0);bb.buildBlock(6,0,-6,Blocks.planks,1);bb.buildBlock(6,0,-5,Blocks.wooden_door,2);
		bb.buildBlock(6,0,-4,Blocks.wooden_door,2);bb.buildBlock(6,0,-3,Blocks.planks,1);bb.buildBlock(6,0,-2,Blocks.planks,1);
		bb.buildBlock(6,0,-1,Blocks.fence,0);bb.buildBlock(6,0,0,Blocks.fence,0);bb.buildBlock(6,0,1,Blocks.fence,0);
		bb.buildBlock(6,0,2,Blocks.fence,0);bb.buildBlock(6,0,3,Blocks.fence,0);bb.buildBlock(6,0,4,Blocks.fence,0);
		bb.buildBlock(6,0,5,Blocks.fence,0);bb.buildBlock(6,0,6,Blocks.fence,0);bb.buildBlock(-6,1,-6,Blocks.planks,1);
		bb.buildBlock(-6,1,-5,Blocks.planks,1);bb.buildBlock(-6,1,-4,Blocks.planks,1);bb.buildBlock(-6,1,-3,Blocks.planks,1);
		...
		bb.buildBlock(-6,1,6,Blocks.fence,0);bb.buildBlock(-5,1,-6,Blocks.planks,1);bb.buildBlock(-5,1,-2,Blocks.planks,1);
		bb.buildBlock(-5,1,6,Blocks.fence,0);bb.buildBlock(-4,1,-6,Blocks.planks,1);bb.buildBlock(-4,1,-2,Blocks.planks,1);
		bb.buildBlock(-4,1,6,Blocks.fence,0);bb.buildBlock(-3,1,-6,Blocks.planks,1);bb.buildBlock(-3,1,-2,Blocks.wooden_door,9);
		bb.buildBlock(-3,1,6,Blocks.fence,0);bb.buildBlock(-2,1,-6,Blocks.planks,1);bb.buildBlock(-2,1,-2,Blocks.planks,1);
		bb.buildBlock(-2,1,6,Blocks.fence,0);bb.buildBlock(-1,1,-6,Blocks.planks,1);bb.buildBlock(-1,1,-4,Blocks.flower_pot,3);
		bb.addTileEntityPot(-1,1,-4,38,3);
		...
		bb.buildBlock(7,5,-4,Blocks.wooden_slab,4);bb.buildBlock(1,1,-1,Blocks.torch,3);bb.buildBlock(-5,3,-5,Blocks.torch,3);
		bb.buildBlock(-5,3,-3,Blocks.torch,4);bb.buildBlock(-1,3,-3,Blocks.torch,4);bb.buildBlock(1,3,-5,Blocks.torch,1);
		bb.buildBlock(1,3,-3,Blocks.torch,1);bb.buildBlock(5,3,-5,Blocks.torch,2);bb.buildBlock(5,3,-3,Blocks.torch,2);
		bb.addEntityPainting(-6,2,-4,3,"Plant");
		bb.addEntityItemFrame(6,1,-3,3,ModBlocks.blockFarmland,0);
	}
