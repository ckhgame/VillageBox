...
public class BuildingSmallHotel extends Building {
	...
	protected void buildBlocks(BuildingBuilder bb) {
		...
		bb.buildBlock(2,-6,2,Blocks.planks,2);bb.buildBlock(-2,-5,-3,Blocks.stonebrick,2);bb.buildBlock(-2,-5,-2,Blocks.planks,1);
		bb.buildBlock(-2,-5,-1,Blocks.stonebrick,2);bb.buildBlock(-2,-5,0,Blocks.stonebrick,2);bb.buildBlock(-1,-5,-2,Blocks.planks,1);
		...
		bb.buildBlock(2,-5,1,Blocks.planks,1);bb.buildBlock(2,-5,2,Blocks.planks,2);bb.buildBlock(3,-5,0,Blocks.stonebrick,2);
		bb.buildBlock(-2,-4,-3,Blocks.stonebrick,2);bb.buildBlock(-2,-4,-2,Blocks.air,0);bb.buildBlock(-2,-4,-1,Blocks.spruce_stairs,2);
		...
		bb.buildBlock(1,-4,-3,Blocks.stonebrick,2);bb.buildBlock(1,-4,-2,Blocks.air,0);bb.buildBlock(1,-4,-1,Blocks.air,0);
		...
		bb.buildBlock(2,-4,1,Blocks.planks,1);bb.buildBlock(2,-4,2,Blocks.planks,2);bb.buildBlock(3,-4,0,Blocks.stonebrick,2);
		bb.buildBlock(-2,-3,-2,Blocks.air,0);bb.buildBlock(-2,-3,-1,Blocks.air,0);bb.buildBlock(-2,-3,0,Blocks.spruce_stairs,2);
		bb.buildBlock(-2,-3,1,Blocks.planks,2);bb.buildBlock(-2,-3,2,Blocks.stonebrick,2);bb.buildBlock(-1,-3,-2,Blocks.wooden_door,8);
		...
		bb.buildBlock(-2,-2,0,Blocks.air,0);bb.buildBlock(-2,-2,1,Blocks.spruce_stairs,2);bb.buildBlock(-2,-2,2,Blocks.stonebrick,2);
		bb.buildBlock(-1,-2,-2,Blocks.planks,1);bb.buildBlock(-1,-2,-1,Blocks.planks,1);bb.buildBlock(-1,-2,0,Blocks.planks,1);
		bb.buildBlock(-1,-2,1,Blocks.planks,1);bb.buildBlock(-1,-2,2,Blocks.planks,2);bb.buildBlock(-1,-2,3,Blocks.stonebrick,2);
		bb.buildBlock(0,-2,-1,Blocks.air,0);bb.buildBlock(0,-2,0,Blocks.air,0);bb.buildBlock(0,-2,2,Blocks.planks,2);
		bb.buildBlock(0,-2,3,Blocks.stonebrick,2);bb.buildBlock(1,-2,-1,Blocks.air,0);bb.buildBlock(1,-2,0,Blocks.air,0);
		...
		bb.buildBlock(-1,-1,1,Blocks.planks,2);bb.buildBlock(-1,-1,2,Blocks.planks,2);bb.buildBlock(-1,-1,3,Blocks.stonebrick,2);
		bb.buildBlock(0,-1,-3,Blocks.stonebrick,2);bb.buildBlock(0,-1,-2,Blocks.planks,2);bb.buildBlock(0,-1,-1,Blocks.planks,2);
		bb.buildBlock(0,-1,0,Blocks.planks,2);bb.buildBlock(0,-1,1,Blocks.planks,2);bb.buildBlock(0,-1,2,Blocks.planks,2);
		bb.buildBlock(0,-1,3,Blocks.stonebrick,2);bb.buildBlock(1,-1,-2,Blocks.planks,2);bb.buildBlock(1,-1,-1,Blocks.planks,2);
