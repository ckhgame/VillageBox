...
public class ProfessionHunter extends Profession {
	...
	public void initVillagerChat(VillagerChat villagerChat) {
		...
		villagerChat.add(0, "villager.hunter.chat0");
		villagerChat.add(0, "villager.hunter.chat1");
		villagerChat.add(0, "villager.hunter.chat2");
	...
	protected void setTimeSchedule(){
		timeSchedule.setWorkTime(0, new RangeInt(9,16));	
		
		timeSchedule.setWorkTime(2, new RangeInt(9,16));	
		timeSchedule.setWorkTime(3, new RangeInt(9,16));	
		timeSchedule.setWorkTime(4, new RangeInt(9,16));	
		timeSchedule.setWorkTime(5, new RangeInt(9,16));	
		timeSchedule.setWorkTime(6, new RangeInt(9,16));	
