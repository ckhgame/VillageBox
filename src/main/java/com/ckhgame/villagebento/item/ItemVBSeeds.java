...
import com.ckhgame.villagebento.block.BlockVBCrops;
...
public class ItemVBSeeds extends ItemVB implements IPlantable {

	private BlockVBCrops blockCrops;
	
	public ItemVBSeeds(String name, String info, CreativeTabs tab,BlockVBCrops blockCrops) {
		super(name, info, tab);
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else if (p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_) && p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_ + 1, p_77648_6_, p_77648_7_, p_77648_1_))
        {
            ...
            {
                p_77648_3_.setBlock(p_77648_4_, p_77648_5_ + 1, p_77648_6_, this.blockCrops);
