...
import com.ckhgame.villagebento.item.ItemFishingRodVB;
...
public class EntityFishHookVB extends Entity
{
    ...
    public EntityFishHookVB(World p_i1764_1_)
    {
        super(p_i1764_1_);
    ...
    public EntityFishHookVB(World p_i1766_1_, EntityPlayer p_i1766_2_)
    {
        super(p_i1766_1_);
        this.field_146037_g = -1;
        this.field_146048_h = -1;
        ...
        else
        {
            if (!this.worldObj.isRemote)
            {
                ...
                if (	this.field_146042_b.isDead ||
                		...
                		itemstack == null ||
                		(itemstack.getItem() != ModItems.itemFishingRodIron &&
        				itemstack.getItem() != ModItems.itemFishingRodGold &&
						itemstack.getItem() != ModItems.itemFishingRodDiamond) ||
