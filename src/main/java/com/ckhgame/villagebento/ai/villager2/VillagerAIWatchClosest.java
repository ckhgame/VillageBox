...
public class VillagerAIWatchClosest extends EntityAIBase
{
    ...
    public VillagerAIWatchClosest(EntityVBVillager p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
    {
    ...
    public VillagerAIWatchClosest(EntityVBVillager p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
